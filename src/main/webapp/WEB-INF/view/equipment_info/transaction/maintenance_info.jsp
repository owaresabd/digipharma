...
<div class="container-fluid">
	<div class="block-header">
	    <span style="text-shadow: 2px 2px 2px #aaa;">MAINTENANCE INFO</span>
					...
					<table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="countryList">
						<thead>
							<tr>
								...
								<th class="align-center" style="width: 110px;">LAST SCHEDULE</th>
								<th class="align-center" style="width: 110px;">NEXT SCHEDULE</th>
						...
						<tbody>
							...
							<c:choose>
							  <c:when test="${info.notifyTime !=0 && info.diffDays <= info.notifyTime}">
							  <tr class="bg-pink">
								...
								<td class="align-center">
									<fmt:formatDate pattern="dd-MMM-yyyy" value="${info.nextSchedule}" var="dateValNext" />
	                              	<c:out value="${dateValNext}"/>
								</td>
								<td class="align-center">
									
									    <c:if test="${not empty (info.attachmentNm)}">
								...
								<td class="align-center">
									...
									<input type="hidden" id="r_equipmentId" value="${info.equipmentId}">
									<input type="hidden" id="r_typeId" value="${info.typeId}">
									<input type="hidden" id="r_typeName" value="${info.typeName}">
									<input type="hidden" id="r_freqType" value="${info.freqType}">
									<input type="hidden" id="r_freqDuration" value="${info.freqDuration}">
									<input type="hidden" id="r_lastSchedule" value="${info.lastSchedule}">
									<input type="hidden" id="r_nextSchedule" value="${info.nextSchedule}">
									<input type="hidden" id="r_attachment_image" value="${info.attachmentNm}">
         ...
         <div class="modal-dialog" role="document">
             ...
             <div class="modal-header bg-cyan" >
                 <table class="table table-bordered" style="border: 2px solid #ddd;">
                 	...
                 	<td rowspan="3" class="text-center font-bold" style="font-size: 16px !important">Form: Maintenance Information</td>
