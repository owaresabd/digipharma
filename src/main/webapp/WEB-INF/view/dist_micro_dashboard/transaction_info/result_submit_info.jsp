				...
				<table class="table table-bordered table-striped table-hover">
					...
					<tbody>
						...
						<tr>
							...
							<c:if test="${infos.isAccept eq 'P'}">
							<a class="btn-edit btn btn-info btn-sm" onclick="resultAccept(this)">ACCEPT</a>
						    <!-- <a class="btn-edit btn btn-danger btn-sm" onclick="resultNotAccept(this)">NC</a> -->
						    </c:if>
...
$(".load").on('click', function(e){
	var link =  "${pageContext.request.contextPath}/result/microResultSubmittedList";
