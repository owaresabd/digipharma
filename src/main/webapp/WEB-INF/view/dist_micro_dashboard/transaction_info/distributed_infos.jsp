...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">DISTRIBUTED SAMPLE LIST</span>
					...
					<table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="typeList">
						<thead>
							<tr>
								...
								<th class="align-left" style="width: 160px;">SAMPLE ID</th>
								<th class="align-left">NAME OF SAMPLE</th>
								<th class="align-left" style="width: 160px;">DISTRIBUTED DATE &amp; TIME</th>
								<th class="align-center">STATUS</th>
								<th class="align-center" style="width: 150px;">ACTION</th>
							</tr>
						</thead>
						<tbody>
							<c:forEach var="info" items="${distributedList}" varStatus="counter">
							<tr>
								...
								<fmt:formatDate var="receiveDate" value="${info.microDistDate}" pattern="dd-MMM-yyyy hh:mm:ss aa"/>
								${receiveDate}
								</td>
								...
								<td class="align-center">
									...
									<a class="btn-edit btn btn-xs" onclick="dsMicroInfoPrint('${info.id}','${info.udSampleNo}')"><i class="material-icons">print</i></a> 
								</td>
							</tr>
							</c:forEach>
						</tbody>
...
$(".load").on('click', function(e){
	var link =  "${pageContext.request.contextPath}/distribution/maintain";
...
function view(el) {
	...
	$.ajax({
		async : false,
		url : "${pageContext.request.contextPath}/micro_distribution/getDistributedInfo/" + id ,
...
function dsMicroInfoPrint(id,sampleNo) {
	var ajaxURL = "${pageContext.request.contextPath}/micro_distribution/dsMicro-report?requestId="+id+'&sampleNo='+sampleNo;
