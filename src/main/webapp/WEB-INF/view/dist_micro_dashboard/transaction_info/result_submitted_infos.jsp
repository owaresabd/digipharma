							...
							<tr>
								...
								<td class="field_type_status align-center" width="100px">
									<c:choose>
									    ...
									    <c:when test="${info.resultStatus =='V'}">
											<span class="badge bg-green">Result Submited</span>
									    </c:when>     
									</c:choose>
								</td>
								<td class="align-center">
									<input type="hidden" id="row_id" value="${info.sampleRcvId}">
									<a class="btn-edit btn btn-xs" onclick="view(this)"><i class="material-icons">near_me</i></a>
...
function view(el) {
	...
	$.ajax({
		async : false,
		url : "${pageContext.request.contextPath}/result/getMicroResultSubmitInfo/" + id ,
