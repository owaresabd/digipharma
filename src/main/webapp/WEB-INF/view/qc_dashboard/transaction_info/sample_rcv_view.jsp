                 	...
                 	<div class="modal-body">
                 		...
                 		<div class="row">
                 			<div class="col-md-3">
                            	...
                            	<div class="form-group">
                            	<c:if test="${not empty info.totalSamAmt}">
                            	<fmt:formatNumber type ="number" maxFractionDigits ="3" value ="${info.totalSamAmt}"/>&nbsp;${info.matUnitName}
	                            </c:if>
                            	</div>
                            </div>
                            <c:if test="${not empty info.chemiSamAmt}">
                            <div class="col-md-3">
                            	<span><b>REQUIRED TEST SAMPLE (CHEMICAL) :</b></span>
                            	<div class="form-group">
                            	<c:if test="${not empty info.chemiSamAmt}">
                            		${info.chemiSamAmt}&nbsp;${info.matUnitName}
	                            </c:if>
                            	</div>
                            </div>
                            </c:if>
                 		...
                 		<c:if test="${not empty info.keptAmount}">
                 		<div class="row">
                           <div class="col-md-3">
                            	<span><b>WORKING STANDARD KEPT AMOUNT :</b></span>
                            	<div class="form-group">
                            	
                            		${info.keptAmount}&nbsp;${info.matUnitName}
							...
							<div class="panel-body">
								<div class="row">
									<div class="col-md-2">
										...
										<c:if test="${not empty info.stChemiQty}">
										<div class="form-group">
											${info.stChemiQty} &nbsp;${info.stUnitName}
										</div>
										</c:if>
									</div>
									<div class="col-md-2">
									...
									<div class="col-md-2">
										<span><b>TOTAL RECEIVED QTY :</b></span>
										<div class="form-group">
