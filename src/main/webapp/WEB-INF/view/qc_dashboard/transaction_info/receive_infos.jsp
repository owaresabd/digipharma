...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">SAMPLE RECEIVE LIST</span>
					...
					<table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="typeList">
						<thead>
							<tr>
								...
								<th class="align-left" style="width: 100px;">SAMPLE ID</th>
								<th class="align-left">AR NO</th>
								<th class="align-left">NAME OF SAMPLE</th>
								<th class="align-left" style="width: 150px;">RECEIVED DATE &amp; TIME</th>
						...
						<tbody>
							...
							<tr>
								...
								<td class="field_type_code">${info.arnNo}</td>
								...
								<td class="align-center">
									...
									<a class="btn-edit btn btn-xs" onclick="qcReceiveInfoPrint('${info.id}','${info.udSampleNo}')"><i class="material-icons">print</i></a>
								</td>
							</tr>
							</c:forEach>
						</tbody>
...
function view(el) {
	...
	$.ajax({
		async : false,
		url : "${pageContext.request.contextPath}/qc/getSampleRcvInfo/" + id ,
...
function add(el) {
	...
	$.ajax({
		async : false,
		url : "${pageContext.request.contextPath}/distribution/sampleDistributionForm/" + id ,
...
function qcReceiveInfoPrint(id,sampleNo) {
	var ajaxURL = "${pageContext.request.contextPath}/qc/qcReceive-report?requestId="+id+'&sampleNo='+sampleNo;
