...
<div class="modal-header bg-cyan">
    <table class="table table-bordered" style="border: 2px solid #ddd;">
    	...
    	<td colspan="2">15 Jan 2020</td>
                ...
                <form method="post" id="qcInfoPtForm"  onkeypress="if (event.keyCode == 13) { return false; }">
                            	...
                            	<table id="reqTable" class="table table-bordered table-striped table-hover">
											<thead>
												<tr>
													...
													<th class="align-center" style="width: 120px;">Batch Lot</th>
													...
													<th class="align-center" style="width: 130px;">Pack Size</th>
...
<script>
$("#qcInfoPtForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#qcInfoPtForm").serialize();
	swal({
        title: "Are you sure?",
        text: "Your request will be sent to QC!!!",
        type: "warning",
        showCancelButton: true,
        confirmButtonColor: "#00973E",
        confirmButtonText: "Yes, Request To QC!",
    	...
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/pt_sample/send-ptSample-info",
	        type: 'POST',
	        data: formData,
	        async: false,
