...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;"> REAGENT SETUP</span>
					...
					<table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="typeList">
						<thead>
							<tr>
								...
								<th class="align-left">REAGENT ID</th>
								<th class="align-left">REAGENT NAME</th>
								<th class="align-left">REAGENT TYPE</th>
						...
						<tbody>
							<c:forEach var="info" items="${infos}" varStatus="counter">
							 <tr>
								...
								<td class="field_type_status align-left" width="100px">
									<c:choose>
									    <c:when test="${info.reagentType =='S'}">
											<span >Solid</span>
									    </c:when>    
									    <c:otherwise>
									        <span >Liquid</span>
								...
								<td class="align-center">
									...
									<input type="hidden" id="row_reagent_type" value="${info.reagentType}">
         ...
         <div class="modal-dialog" role="document">
             <div class="modal-content">
                 <div class="modal-header bg-blue-grey">
                    ...
                    <h4 class="modal-title align-center" id="defaultModalLabel"> REAGENT INFORMATION</h4>
                 </div>
                 	...
                 	<div class="modal-body">
                 		...
                 		<div class="row">
	                 		<div class="col-md-4 align-right top">
                            	<label for="method_name">REAGENT ID :</label>
                            </div>
                            <div class="col-md-8">
                 		...
                 		<div class="row">
	                 		<div class="col-md-4 align-right top">
                            	<label for="method_name">REAGENT NAME :</label>
                            </div>
                            <div class="col-md-8">
	                            <div class="form-group">
                 		...
                 		<div class="row">
	                 		<div class="col-md-4 align-right top">
                            	<label for="method_name">REAGENT TYPE :</label>
                            </div>
                            <div class="col-md-6">
	                            <div class="form-group">
	                            	 <select id="reagentType" name="reagentType" class="js-example-theme-single form-control" style="width: 60%;" required="required">
				                        <option>Select Reagent Type</option>
                 		...
                 		<div class="row">
                            ...
                            <div class="col-md-6">
	                            <div class="form-group">
	                            	 <select id="unitId" name="unitId" class="js-example-theme-single form-control" style="width: 60%;" required="required">
...
function add(el) {
	...
	$('#reagentType').val('').trigger('change.select2');
...
function edit(el) { 
	...
	var reagentType = $(el).closest('tr').find("#row_reagent_type").val();
	...
	$('#reagentType').val(reagentType).trigger('change.select2');
...
$("#productInfoForm").submit(function(event){
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/reagent/saveReagentInfo",
	        type: 'POST',
	        data: formData,
	        async: false,
