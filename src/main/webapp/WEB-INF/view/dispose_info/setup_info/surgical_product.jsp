...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;"> QC OTHER ACCESSORIES</span>
					...
					<table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="typeList">
						<thead>
							<tr>
								...
								<th class="align-left">ACCESSORIES ID</th>
								<th class="align-left">ACCESSORIES NAME</th>
         ...
         <div class="modal-dialog" role="document">
             <div class="modal-content">
                 <div class="modal-header bg-blue-grey">
                    ...
                    <h4 class="modal-title align-center" id="defaultModalLabel"> QC OTHER ACCESSORIES INFORMATION</h4>
                 </div>
                 	...
                 	<div class="modal-body">
                 		...
                 		<div class="row">
	                 		<div class="col-md-4 align-right top">
                            	<label for="method_name">ACCESSORIES CODE :</label>
                            </div>
                            <div class="col-md-8">
