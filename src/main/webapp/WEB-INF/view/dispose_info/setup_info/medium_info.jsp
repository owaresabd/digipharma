...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;"> MEDIUM &amp; REAGENT SETUP</span>
					...
					<table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="typeList">
						<thead>
							<tr>
								...
								<th class="align-left">NAME OF MEDIUM/ REAGENT </th>
								<th class="align-left">CODE NO.</th>
						...
						<tbody>
							<c:forEach var="info" items="${infos}" varStatus="counter">
							 <tr>
								...
								<td class="field_equipment_name">${info.reagentName}</td>
								<td class="field_type_name">${info.codeNo}</td>
								...
								<td class="align-center">
									...
									<input type="hidden" id="row_reagent_name" value="${info.reagentName}">
									<input type="hidden" id="row_code_no" value="${info.codeNo}">
         ...
         <div class="modal-dialog" role="document">
             <div class="modal-content">
                 <div class="modal-header bg-blue-grey">
                    ...
                    <h4 class="modal-title align-center" id="defaultModalLabel">  MEDIUM &amp; REAGENT SETUP</h4>
                 </div>
                 <form method="post" id="productInfoForm" modelAttribute="mediumInfo">
                 	<div class="modal-body">
                 		<div class="alert-code alert-block alert-danger hidden"></div><br>
                 		<input type="hidden" id="id" name="id" value=""/>
                 		
                 		<div class="row">
	                 		<div class="col-md-5 align-right top">
                            	<label for="method_name">NAME OF MEDIUM/ REAGENT  :</label>
                            </div>
                            <div class="col-md-7">
	                            <div class="form-group">
	                            	<input type="text" id="reagentName" name="reagentName" maxlength="20" value="" class="form-control"  autocomplete="off" >
	                            </div>
                            </div>
                 		</div>
                 		<div class="row">
	                 		<div class="col-md-5 align-right top">
                            	<label for="method_name">CODE NO. :</label>
                            </div>
                            <div class="col-md-7">
	                            <div class="form-group">
	                            	<input type="text" id="codeNo" name="codeNo" maxlength="50" value="" class="form-control"  autocomplete="off" >
	                            </div>
                            </div>
                 		</div>
...
function edit(el) { 
	...
	var reagentName= $(el).closest("tr").find("#row_reagent_name").val();
	var codeNo = $(el).closest('tr').find("#row_code_no").val();
	var status 		= $(el).closest('tr').find("#r_status").val();
	
	
	$("#id").val(Id);
	$("#reagentName").val(reagentName);
	$("#codeNo").val(codeNo);
...
$("#productInfoForm").submit(function(event){
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/reagent/saveMediumReagentInfo",
	        type: 'POST',
	        data: formData,
	        async: false,
