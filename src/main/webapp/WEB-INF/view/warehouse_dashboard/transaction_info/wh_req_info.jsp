...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">WAREHOUSE REQUEST INFO</span>
						...
						<tbody>
							...
							<tr>
								...
								<td class="align-center">
									...
									<input type="hidden" id="s_invoiceNo" value="${info.invoiceNo}">
									<input type="hidden" id="s_chalanNo" value="${info.chalanNo}">
									<input type="hidden" id="s_lcNo" value="${info.lcNo}">
									...
									<input type="hidden" id="s_rcvQty" value="${info.rcvQty}">
									<input type="hidden" id="s_unitId" value="${info.rcvUnitId}">
									<input type="hidden" id="s_unitName" value="${info.rcvUnitName}">
									<input type="hidden" id="s_manufacture_id" value="${info.manufactureId}">
									<input type="hidden" id="s_manufactureName" value="${info.manufactureName}">  
									<input type="hidden" id="s_countryId" value="${info.countryId}">
									<input type="hidden" id="s_grNo" value="${info.grNo}">
									<input type="hidden" id="s_sampleDetails" value="${info.sampleDetails}">
									<input type="hidden" id="s_is_working_standard" value="${info.isWorkingStandard}">   
...
$(".load").on('click', function(e){
	var link =  "${pageContext.request.contextPath}/warehouse/maintain";
...
function edit(el) {
	...
	var materialName=$(el).closest("tr").find("#s_materialName").val();
	...
	var isStandard=$(el).closest("tr").find("#s_is_working_standard").val();
...
$("#whRequestInfoForm").submit(function(event){
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/warehouse/save-whRequest-infos",
	        type: 'POST',
	        data: formData,
	        async: false,
	        success: function (data) {				 
