...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">Material Type Info</span>
			...
			<div class="card">
				<div class="body table-responsive table-bordered">
					...
					<table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="typeList">
						<thead>
							<tr>
								<th class="align-center" style="width: 100px;">TYPE CODE</th>
...
<!------------------------ Start:  Modal -------------------->
<div class="modal fade" id="materialTypeInfoModal" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false">
         <div class="modal-dialog" role="document">
             ...
             <div class="modal-header bg-cyan" >
                 	...
                 	<td rowspan="3" class="text-center font-bold" style="font-size: 16px !important">Form: Material Type Info </td>
                 	<td>Document No.</td>
                 	<td colspan="2">FM-DIL-GN-072</td>
                 	</tr>
                 ...
                 <form method="post" id="materialTypeInfoForm" modelAttribute="materialTypeInfo">
                 	<div class="modal-body">
                 		<div class="alert-code alert-block alert-danger hidden"></div><br>
                 		<input type="hidden" id="id" name="id" value=""/>
                 		<div class="row">
	                 		<div class="col-md-4 align-right top">
                            	<label for="service_item">TYPE CODE :</label>
                            </div>
                            <div class="col-md-8">
...
$('#typeNo').keyup(function() {
	...
	$.get( "${pageContext.request.contextPath}/materialtype/validate-typeNo/" + typeNo, 
	function( data ) {
...
$("#materialTypeInfoForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#materialTypeInfoForm").serialize();
    swal({
        title: "Are you sure?",
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/materialtype/save-material-type-info",
	        type: 'POST',
	        data: formData,
	        async: false,
	        success: function (data) {				 
	        	$("#materialTypeInfoModal").modal('hide');
