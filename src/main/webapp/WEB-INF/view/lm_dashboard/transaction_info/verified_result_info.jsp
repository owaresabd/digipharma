...
<div class="modal-header bg-cyan">
    <table class="table table-bordered" style="border: 2px solid #ddd;">
    	...
    	<td colspan="2">15 Jan 2020</td>
                ...
                <form method="post" id="qcResultVerifyByLmInfoForm" >
				...
				<table class="table table-bordered table-striped table-hover">
					<thead>
						<tr>
							...
							<th class="align-center" style="width: 60px;">DECISION RULE</th>
					...
					<c:forEach var="infos" items="${infos}" varStatus="counter">
						<tr>
							<td class="align-center">
								<input type="hidden" id="resultId" name="resultId[]" value="${infos.id}"/>
								${infos.testParameterName}
							</td>
							...
							<td class="align-center">
								<select  id=isDecision name="isDecision[]" class="js-example-theme-single form-control" style="width: 100%;" required="required">
				                        <option></option>
				...
				<span class="col-md-1">Opinion :</span><span class="col-md-5"><textarea name="opinion" rows="3" cols="60"></textarea></span>
				<span class="col-md-1">Remarks :</span><span class="col-md-5"><textarea name="remarks" rows="3" cols="60"></textarea></span>
				</div>
	                 ...
	                 <div class="modal-footer save-footer align-center" style="background-color: #cff0f5;">
	                 	<button type="button" class="btn bg-deep-orange btn-sm waves-effect pull-left m-r-10"  data-dismiss="modal">
							<i class="material-icons">close</i><span>NC</span>
						</button>
						<button type="submit" id="saveBtn" class="btn bg-green btn-sm waves-effect pull-left m-r-10">
...
$("#qcResultVerifyByLmInfoForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#qcResultVerifyByLmInfoForm").serialize();
    swal({
        title: "Are you sure?",
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
    		url : "${pageContext.request.contextPath}/lm/saveResultVerifyInfo",
	        type: 'POST',
	        data: formData,
	        async: false,
