...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">RETENTION SAMPLE RECEIVE INFO</span>
...
<div class="modal fade" id="retViewInfoModal" style="overflow: auto !important;"  role="dialog" data-backdrop="static" data-keyboard="false"  >
...
$(".load").on('click', function(e){
	var link =  "${pageContext.request.contextPath}/retention/receivedList";
	$("#retViewInfoModal").modal('hide');
...
function view(el) {
	...
	$.ajax({
		async : false,
		url : "${pageContext.request.contextPath}/retention/getSampleRcvInfo/" + id ,
		success : function(data) {
			$('#retViewInfoModal').modal('show').find('.modal-content').html(data);
