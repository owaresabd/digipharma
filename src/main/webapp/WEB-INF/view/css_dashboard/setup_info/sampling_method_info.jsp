...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">SAMPLING METHOD INFORMATION</span>
					...
					<table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="typeList">
						<thead>
							<tr>
								...
								<th class="align-left">SAMPLING METHOD NAME</th>
...
<div class="modal fade" id="samplingMethodModal" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false">
         <div class="modal-dialog" role="document">
             <div class="modal-content">
                 <div class="modal-header bg-blue-grey">
                 	<button type="button" class="mod-cl close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    <h4 class="modal-title align-center" id="defaultModalLabel">SAMPLING METHOD INFORMATION</h4>
                 </div>
                 <form method="post" id="samplingMethodForm" modelAttribute="samplingMethodInfo">
...
$("#samplingMethodForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#samplingMethodForm").serialize();
    swal({
        title: "Are you sure?",
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/sampleMethod/save-sampleMethod-info",
	        type: 'POST',
	        data: formData,
	        async: false,
	        success: function (data) {				 
	        	$("#samplingMethodModal").modal('hide');
