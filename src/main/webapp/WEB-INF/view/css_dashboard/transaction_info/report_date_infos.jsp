					...
					<table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="typeList">
						<thead>
							<tr>
								...
								<th class="align-center" style="width: 200px;">SAMPLE ID</th>
								<th class="align-center" style="width: 200px;">NAME OF SAMPLE</th>
...
function view(el) {
	...
	$.ajax({
		async : false,
		url : "${pageContext.request.contextPath}/css/getTestResultDateInfo/"+ id ,
		success : function(data) {
...
$("#testReportForm").submit(function(event){
	alert("OK");
	event.preventDefault();				
    var formData = $("#testReportForm").serialize();
    swal({
        title: "Are you sure?",
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/css/updateTestDate",
	        type: 'POST',
	        data: formData,
	        async: false,
	        success: function (data) {				 
