...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">SENT SAMPLE INFORMATION</span>
			...
			<div class="card">
				<div class="body table-responsive table-bordered">
					...
					<table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="typeList">
						...
						<tbody>
							<c:forEach var="info" items="${sentSampleList}" varStatus="counter">
							<tr>
...
<div class="modal fade" id="sentSampleInfoModal" style="overflow: auto !important;"  role="dialog" data-backdrop="static" data-keyboard="false" aria-hidden="true" >
...
function view(el) {
	...
	$.ajax({
		...
		success : function(data) {
			$('#sentSampleInfoModal').modal('show').find('.modal-content').html(data);
