			...
			<div class="card ">
				<div class="body">
					...
					<div class="row">
						...
						<div class="col-md-3">
                           	<select id="equipment_id" class="js-example-theme-single form-control" onchange="getMeltingPointCleanPendingInfos()" style="width: 100%;">
...
setTimeout(function() {
      getMeltingPointCleanPendingInfos();
    }, 2);
});	 
...
function getMeltingPointCleanPendingInfos(){
    var equipmentId = $('#equipment_id option:selected').val();
	var ajaxURL = "${pageContext.request.contextPath}/logbook_chemi/getMeltingPointCleanPendingInfos?equipmentId="+equipmentId;
		$.ajax({
			async : false,
			url : ajaxURL ,
