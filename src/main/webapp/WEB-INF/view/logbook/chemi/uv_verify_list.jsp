...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">UV SPECTROPHOTOMETER VERIFY INFO</span>
...
$("#waterPurificationUpdateForm").submit(function(event){
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_chemi/verifyUvSpectroPhotoMeter",
	        type: 'POST',
	        data: formData,
	        async: false,
