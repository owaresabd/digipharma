...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">BIOCHEMICAL OXYGEN DEMAND(BOD) CLEAN INFO</span>
		
	</div>
		   <form method="post" id="autoPolarimeterForm" onkeypress="if (event.keyCode == 13) { return false; }">
...
$("#autoPolarimeterForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#autoPolarimeterForm").serialize();
	
	
    swal({
        title: "Are you sure?",
        text: "You will Clean selected data!",
        type: "warning",
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_chemi/cleanBiochemicalOxygen",
	        type: 'POST',
	        data: formData,
	        async: false,
