					...
					<table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="verifyTable">
						<thead>
							<tr>
								...
								<th class="align-center" style="width: 150px;">COLUMN RECEIVED BY AND DATE</th>
								...
								<th class="align-center" style="width: 110px;">OPENING DATE</th>
						...
						<tbody>
							...
							<tr>
								...
								<c:choose>
									    <c:when test="${info.isReceive =='Y'}">
										<span>${info.colRcvByName}, </span>
...
$("#ftirVerifyForm").submit(function(event){
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_chemi/verifyColRcvDistribution",
	        type: 'POST',
	        data: formData,
	        async: false,
