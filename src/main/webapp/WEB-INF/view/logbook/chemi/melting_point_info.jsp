...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">LOG BOOK:: MELTING POINT APPARATUS INFO</span>
...
<div class="modal fade" id="melPointInfoModal" style="overflow: auto;" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false">
         <div class="modal-dialog modal-lg" role="document">
             ...
             <div class="modal-header bg-cyan" >
                 	...
                 	<td rowspan="3" class="text-center font-bold" style="font-size: 16px !important">Log Book :: Melting Point Apparatus</td>
                 	<td style="width:90px">Document No.</td>
                 	<td colspan="2" style="width:120px">LB-DIL-CM-042</td>
                 	</tr>
                 ...
                 <form method="post" id="melPointInfoForm" >
...
$("#melPointInfoForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#melPointInfoForm").serialize();
    swal({
        title: "Are you sure?",
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_chemi/saveMeltingPointInfo",
	        type: 'POST',
	        data: formData,
	        async: false,
