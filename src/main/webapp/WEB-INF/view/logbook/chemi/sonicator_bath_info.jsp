...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">LOG BOOK:: SONICATOR BATH INFO</span>
...
<div class="modal fade" id="dissolutionInfoModal" style="overflow: auto;" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false">
         <div class="modal-dialog  modal-lg" role="document">
             ...
             <div class="modal-header bg-cyan" >
                 	...
                 	<td rowspan="3" class="text-center font-bold" style="font-size: 16px !important">Log Book: Sonicator Bath</td>
                 	<td style="width:90px">Document No.</td>
                 	<td colspan="2" style="width:120px">LB-DIL-CM-023</td>
                 	</tr>
                 ...
                 <form method="post" id="sonicationBathInfoForm" >
...
$("#sonicationBathInfoForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#sonicationBathInfoForm").serialize();
    swal({
        title: "Are you sure?",
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_chemi/saveSonicatorBathInfo",
	        type: 'POST',
	        data: formData,
	        async: false,
