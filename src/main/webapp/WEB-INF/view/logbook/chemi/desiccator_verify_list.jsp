...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">DESICCATOR VERIFT LIST</span>
		
	</div>
		   <form method="post" id="desiccatorUpdateForm" onkeypress="if (event.keyCode == 13) { return false; }">
...
$("#desiccatorUpdateForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#desiccatorUpdateForm").serialize();
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_chemi/verifyDesiccator",
	        type: 'POST',
	        data: formData,
	        async: false,
