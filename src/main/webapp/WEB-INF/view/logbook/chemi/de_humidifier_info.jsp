...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">LOGBOOK:: DE-HUMIDIFIER</span>
...
//	var dispensedBy 	= $(el).closest("tr").find("#r_dispensed_by").val();
	
		
	$("#id").val(id);
	$("#equipment_id").val(equipmentId).trigger('change.select2');
	//$("#clean_by").val(dispensedBy).trigger('change.select2');
	$("#remarks").val(remarks);
...
$("#waterPurificationInfoForm").submit(function(event){
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_chemi/saveDeHumidifier",
	        type: 'POST',
	        data: formData,
	        async: false,
