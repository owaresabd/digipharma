...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">EHD RETURN INFO</span>
		
	</div>
		   <form method="post" id="ehdForm" onkeypress="if (event.keyCode == 13) { return false; }">
...
$("#ehdForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#ehdForm").serialize();
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_chemi/receuiveEHD",
	        type: 'POST',
	        data: formData,
	        async: false,
			success : function(data) {
				$("#view_page").html(data);
				sweetAlert("Updated!", "Received Successfully", "success", 1000, false);
			},
	        error: function(){
