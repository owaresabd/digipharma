...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">DISSOLUTION INFO</span>
		   ...
		   <form method="post" id="dissVerifyForm" onkeypress="if (event.keyCode == 13) { return false; }">
...
$("#dissVerifyForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#dissVerifyForm").serialize();
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_chemi/verifyDissolution",
	        type: 'POST',
	        data: formData,
	        async: false,
