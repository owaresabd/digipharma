...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">ANALYTICAL BALANCE CLEAN INFO</span>
		
	</div>
		   <form method="post" id="analyticalBalanceCleanForm" onkeypress="if (event.keyCode == 13) { return false; }">
...
$("#analyticalBalanceCleanForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#analyticalBalanceCleanForm").serialize();
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_chemi/cleanAnalyticalBalance",
	        type: 'POST',
	        data: formData,
	        async: false,
			success : function(data) {
				$("#view_page").html(data);
				sweetAlert("Updated!", "Cleaned Successfully", "success", 1000, false);
			},
	        error: function(){
