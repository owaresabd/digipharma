...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">AREA CLEANING VERIFY INFO</span>		
	</div>
		   <form method="post" id="ehdUpdateForm" onkeypress="if (event.keyCode == 13) { return false; }">
...
$("#ehdUpdateForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#ehdUpdateForm").serialize();
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_chemi/verifyAreaClean",
	        type: 'POST',
	        data: formData,
	        async: false,
