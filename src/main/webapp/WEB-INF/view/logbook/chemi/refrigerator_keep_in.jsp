					...
					<table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="typeList">
						...
						<tbody>
							...
							<tr>
								...
								<td class="align-center">
									<c:choose>
									    <c:when test="${info.discardQty != '0'}">
											<span class="badge bg-green">Discarded</span>
									    </c:when>
									<c:otherwise>
                 ...
                 <form method="post" id="refrigeratorInfoForm" modelAttribute="refrigeratorInfo">
                 	<div class="modal-body">
                 		...
                 		<div class="row">
                            ...
                            <div class="col-md-4">
                           	<div class="form-group">
                                <select  id="qc_ref_id" name="qcRefId"  onchange="materialInfoByArn(this.id)" class="js-example-theme-single form-control" style="width: 100%;" required="required">
                         ...
                         <div class="col-md-2">
	                     <div class="form-group">
                                <input type="text" id="qty" name="qty" value="" class="form-control number" style="width: 100%; margin-left: " autocomplete="off" required="required">
                           	</div>
							</div>
							<div class="col-md-2">
                            <div class="form-group">
...
/*function materialInfoByArn(id){
	...
	function( data ) {
		...
		$('#product_id').val(data.materialId).trigger('change.select2');
	});
}*/
