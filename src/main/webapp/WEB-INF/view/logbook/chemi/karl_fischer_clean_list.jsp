...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">KARL FISCHER CLEAN INFO</span>
		
	</div>
		   <form method="post" id="karlFischerCleanForm" onkeypress="if (event.keyCode == 13) { return false; }">
...
$("#karlFischerCleanForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#karlFischerCleanForm").serialize();
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_chemi/cleankKarlFischer",
	        type: 'POST',
	        data: formData,
	        async: false,
