...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">BIOLOGICAL SAFETY INFO</span>
		   ...
		   <form method="post" id="biologicalSafetyUpdateForm" onkeypress="if (event.keyCode == 13) { return false; }">
...
$("#biologicalSafetyUpdateForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#biologicalSafetyUpdateForm").serialize();
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_chemi/verifyBiologicalSafety",
	        type: 'POST',
	        data: formData,
	        async: false,
