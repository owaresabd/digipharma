...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">MUFFLE FURNACE CLEAN INFO</span>
		
	</div>
		   <form method="post" id="muffleFurnaceForm" onkeypress="if (event.keyCode == 13) { return false; }">
...
$("#muffleFurnaceForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#muffleFurnaceForm").serialize();
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_chemi/cleanMuffleFurnace",
	        type: 'POST',
	        data: formData,
	        async: false,
