...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">LOG BOOK:: MUFFLE FURNACE INFO</span>
					...
					<table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="typeList">
						...
						<tbody>
							...
							<tr>
								...
								<td class="align-left">${info.temperature}</td>
...
<div class="modal fade" id="kftInfoModal" style="overflow: auto;" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false">
         <div class="modal-dialog modal-lg" role="document">
             ...
             <div class="modal-header bg-cyan" >
                 	...
                 	<td rowspan="3" class="text-center font-bold" style="font-size: 16px !important">Log Book :: Muffle Furnace</td>
                 	<td style="width:90px">Document No.</td>
                 	<td colspan="2" style="width:120px">LB-DIL-CM-034</td>
                 	</tr>
                 ...
                 <form method="post" id="mufflefurInfoForm" >
...
$("#mufflefurInfoForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#mufflefurInfoForm").serialize();
    swal({
        title: "Are you sure?",
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_chemi/saveMuffleFurnaceInfo",
	        type: 'POST',
	        data: formData,
	        async: false,
