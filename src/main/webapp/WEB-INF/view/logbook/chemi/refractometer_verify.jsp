...
<div class="container-fluid">
	<div class="block-header">
		<span style="text-shadow: 2px 2px 2px #aaa;">REFRACTOMETER VERIFY INFO</span>
...
function getRefractometerVerifiedPendingInfos(){
	...
	var ajaxURL = "${pageContext.request.contextPath}/logbook_chemi/getRefractometerVerifiedPendingInfos?equipmentId="+equipmentId;
		$.ajax({
			async : false,
			url : ajaxURL ,
