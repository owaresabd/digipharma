...
<div class="container-fluid">
	<div class="block-header">
		<span style="text-shadow: 2px 2px 2px #aaa;"> SAMPLE LABEL CONTROL REPORT</span>
	</div>
...
//	if(!id==""){
    ...
    var ajaxURL = "${pageContext.request.contextPath}/logbook_chemi/sampleLabel-log-print?fromDate=" + fromDate+ "&toDate=" + toDate;
	 $.ajax({
		type : "GET",
		url : ajaxURL,
		dataType : 'json',
