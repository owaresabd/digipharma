...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">REFRACTOMETER CLEAN INFO</span>
		
	</div>
		   <form method="post" id="refractometerCleanForm" onkeypress="if (event.keyCode == 13) { return false; }">
...
$("#refractometerCleanForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#refractometerCleanForm").serialize();
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_chemi/cleanRefractometer",
	        type: 'POST',
	        data: formData,
	        async: false,
