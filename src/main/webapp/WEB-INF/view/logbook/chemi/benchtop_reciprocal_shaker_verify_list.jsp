...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">BENCHTOP RECIPROCAL SHAKER VERIFY INFO</span>
		
	</div>
		   <form method="post" id="benchtopRecipUpdateForm" onkeypress="if (event.keyCode == 13) { return false; }">
...
$("#benchtopRecipUpdateForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#benchtopRecipUpdateForm").serialize();
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_chemi/verifyBenchtopReciprocalShaker",
	        type: 'POST',
	        data: formData,
	        async: false,
