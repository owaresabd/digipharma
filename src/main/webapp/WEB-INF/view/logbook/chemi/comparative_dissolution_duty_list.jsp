...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">COMPARATIVE DISSOLUTION STUDY ANALYST ASSIGN LOGBOOK INFO</span>
     ...
     <div class="modal fade" id="columnPerformancePendingModal" style="overflow: auto;" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false">
         <div class="modal-dialog md modal-lg" role="document">
             ...
             <div class="modal-header bg-cyan" >
                 ...
                 <form method="post" id="compDissoDutyForm">
                 ...
                 <form method="post" id="comoareDissolutionDutyForm" onkeypress="if (event.keyCode == 13) { return false; }">
             		...
             		<div class="modal-body">
                 		...
                 		<input type="hidden" id="id_edit" name="id" value=""/>
                            ...
                            <div class="col-md-4">
	                            <div class="form-group">
							   	<select id="analyst_id_edit" name="analystId" class="js-example-theme-single form-control" style="width: 100%;" required="required">
				                   	<option>-Select Analyst-</option>
				                        <c:forEach var="info" items="${sampleByList}">
				                        	<option value="${info.empId }">${info.empName}</option>
				                        </c:forEach>
...
$("#compDissoDutyForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#compDissoDutyForm").serialize();
	swal({
        title: "Are you sure?",
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_chemi/saveDistributeComparativePendingList?updateFlag=V",
	        type: 'POST',
	        data: formData,
	        async: false,
...
$("#comoareDissolutionDutyForm").submit(function(event){
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_chemi/saveDistributeComparativePendingList?updateFlag=E",
	        type: 'POST',
	        data: formData,
	        async: false,
	        success: function (data) {				 
