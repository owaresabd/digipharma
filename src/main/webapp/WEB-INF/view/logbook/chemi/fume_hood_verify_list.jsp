...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">FUME HOOD INFO</span>
		
	</div>
		   <form method="post" id="fumeHoodUpdateForm" onkeypress="if (event.keyCode == 13) { return false; }">
...
$("#fumeHoodUpdateForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#fumeHoodUpdateForm").serialize();
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_chemi/verifyFumeHood",
	        type: 'POST',
	        data: formData,
	        async: false,
