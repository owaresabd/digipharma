...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">WATER SAMPLING VERIFY INFO</span>
		
	</div>
		   <form method="post" id="waterSamplingUpdateForm" onkeypress="if (event.keyCode == 13) { return false; }">
...
$("#waterSamplingUpdateForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#waterSamplingUpdateForm").serialize();
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_chemi/verifyWaterSampling",
	        type: 'POST',
	        data: formData,
	        async: false,
