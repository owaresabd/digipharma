...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">LOG BOOK:: FUME HOOD INFO</span>
					...
					<table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="typeList">
						<thead>
							<tr>
								...
								<th class="align-center" style="width: 180px;">PURPOSE</th>
...
<div class="modal fade" id="fumeHoodInfoModal" style="overflow: auto;" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false">
         <div class="modal-dialog  modal-lg" role="document">
             ...
             <div class="modal-header bg-cyan" >
                 	...
                 	<td rowspan="3" class="text-center font-bold" style="font-size: 16px !important">Log Book :: Fume Hood</td>
                 	<td style="width:90px">Document No.</td>
                 	<td colspan="2" style="width:120px">LB-DIL-CM-039</td>
                 	</tr>
                 ...
                 <form method="post" id="fumeHoodInfoForm" >
                     	...
                     	<div class="row">
                            ...
                            <div class="form-group">
                                <input type="text" id="end_time" name="endTime" value="" class="form-control" style="width: 30%;" autocomplete="off" required="required">
                 				...
                 				<div class="col-md-2 align-right top">
                            	<label for="kft_result">PURPOSE :</label>
                            </div>
                            <div class="col-md-4">
                            <div class="form-group">
...
$("#fumeHoodInfoForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#fumeHoodInfoForm").serialize();
    swal({
        title: "Are you sure?",
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_chemi/savefumeHoodInfo",
	        type: 'POST',
	        data: formData,
	        async: false,
	        success: function (data) {
	        	$("#fumeHoodInfoModal").modal('hide');
