...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">SAMPLE LABEL CONTROL VERIFY INFO</span>
		
	</div>
		   <form method="post" id="SampleLabelUpdateForm" onkeypress="if (event.keyCode == 13) { return false; }">
					...
					<table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="verifyTable">
						...
						<tbody>
							...
							<tr>
								...
								<td class="align-left"><input type="text" style="width:100%" name="remarks[]" id="" value="${info.remarks}"></td>
...
$("#SampleLabelUpdateForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#SampleLabelUpdateForm").serialize();
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_chemi/verifySampleLabel",
	        type: 'POST',
	        data: formData,
	        async: false,
