...
<div class="container-fluid">
	<div class="block-header">
		<span style="text-shadow: 2px 2px 2px #aaa;"> VERIFICATION OF DISSOLUTION MACHINE REPORT</span>
	</div>
				...
				<div class="body">
                    ...
                    <div class="col-md-3">
								...
								<span ><b>EQUIPMENT ID :</b></span>
	                            	<select id="equipment_id" name="equipmentId" onchange="" class="js-example-theme-single form-control" style="width: 100%;" required="required">
...
function printReport(el) {
	var id = $('#equipment_id option:selected').val().trim();
	if(!id==""){
	var fromDate = $("#fromDate").val();
    var toDate = $("#toDate").val();
    var ajaxURL = "${pageContext.request.contextPath}/logbook_chemi/verificationDissolution-log-print?id="+ id+ "&fromDate=" + fromDate+ "&toDate=" + toDate;
	 $.ajax({
		type : "GET",
		url : ajaxURL,
		dataType : 'json',
		...
		sweetAlert("Failed!", "You must Select an Equipment.", "warning", 100000, false);
	}	
}
