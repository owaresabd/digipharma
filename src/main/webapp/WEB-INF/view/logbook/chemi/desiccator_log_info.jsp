...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">DESICCATOR LOG INFO</span>
						...
						<tbody>
							...
							<tr>
								...
								<td class="align-center">
									<c:choose>
							    	<c:when test="${(info.arnNo !=null) && (not empty info.arnNo)}">
									${info.arnNo}
							    	</c:when>    
								    <c:otherwise>
									 N/A
...
<div class="modal fade" id="desiccatorLogInfoModal" style="overflow: auto;" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false">
         <div class="modal-dialog modal-lg" role="document">
             ...
             <div class="modal-header bg-cyan" >
                 	...
                 	<td rowspan="3" class="text-center font-bold" style="font-size: 16px !important">Form: Desiccator Logbook Info </td>
                 	<td style="width:90px">Document No.</td>
                 	<td colspan="2" style="width:120px">LB-DIL-CM-002</td>
                 	</tr>
                 ...
                 <form method="post" id="desiccatorLogInfoForm" modelAttribute="desiccatorLogInfo">
                 	<div class="modal-body">
                 		...
                 		<div class="row">
                            ...
                            <div class="form-group">
                               <select  id="qc_ref_id" name="qcReferenceId" class="js-example-theme-single form-control" style="width: 100%;">
                 		...
                 		<div class="row">
                            ...
                            <div class="col-md-3">
                            <div class="form-group">
                                <input type="text" id="out_date" name="outDate" value="" class="form-control" style="width: 80%;" autocomplete="off" >
                           	</div>
                            </div>
                 		</div>
                 		<div class="row">
...
$("#desiccatorLogInfoForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#desiccatorLogInfoForm").serialize();
    swal({
        title: "Are you sure?",
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_chemi/saveDesiccatorInfo",
	        type: 'POST',
	        data: formData,
	        async: false,
	        success: function (data) {				 
	        	$("#desiccatorLogInfoModal").modal('hide');
