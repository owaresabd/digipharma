...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">SONICATOR BATH LOGBOOK INFO</span>
					...
					<table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="typeList">
						<thead>
							<tr>
								...
								<th class="align-center" style="width: 180px;">Q.C REFERENCE</th>
...
<div class="modal fade" id="sonicatorBathLogInfoModal" style="overflow: auto;" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false">
         <div class="modal-dialog" role="document">
             ...
             <div class="modal-header bg-cyan" >
                 	...
                 	<td rowspan="3" class="text-center font-bold" style="font-size: 16px !important">Form: Sonicator Bath Logbook Info </td>
                 	<td style="width:90px">Document No.</td>
                 	<td colspan="2" style="width:120px">LB-DIL-CM-027</td>
                 	</tr>
                 ...
                 <form method="post" id="sonicatorBathLogInfoForm" modelAttribute="sonicatorBathLogInfo">
                 	<div class="modal-body">
                 		...
                 		<div class="row">
	                 		<div class="col-md-4 align-right top">
                            	<label for="qc_reference">Q.C REFERENCE NO :</label>
                            </div>
                            <div class="col-md-8">
                           	<div class="form-group">
                                <select  id="qc_reference" name="qcReferenceId" class="js-example-theme-single form-control" style="width: 100%;" required="required">
                 		...
                 		<div class="row">
                            ...
                            <div class="col-md-8">
                            <div class="form-group">
                                <input type="text" id="product_name" name="productName" value="" class="form-control" style="width: 100%;" autocomplete="off" required="required">
                           	</div>
                            </div>
                 		</div>
                 		<div class="row">
...
function add(el) {
	...
	$("#remarks").val("");
    $("#sonicatorBathLogInfoModal").modal();
...
$("#sonicatorBathLogInfoForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#sonicatorBathLogInfoForm").serialize();
    swal({
        title: "Are you sure?",
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_chemi/saveSonicatorBathInfos",
	        type: 'POST',
	        data: formData,
	        async: false,
	        success: function (data) {
	        	$("#sonicatorBathLogInfoModal").modal('hide');
...
function printReport(el) {
	var ajaxURL = "${pageContext.request.contextPath}/logbook_chemi/sonicator-bath-log-print";
