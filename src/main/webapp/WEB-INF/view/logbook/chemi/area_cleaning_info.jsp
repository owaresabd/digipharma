...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">AREA CLEANING LOGBOOK INFO</span>
		...
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<div class="card">
				<div class="body table-responsive table-bordered">
					...
					<%-- <c:if test="${not empty areaCleanInfos}">
						...
						<tbody>
							...
							<tr>
								...
								<c:choose>
									...
									<input type="hidden" id="r_cleaning_equipment_id" value="${info.cleaningEquipment}">
             ...
             <div class="modal-header bg-cyan" >
                 ...
                 <form method="post" id="areaCleanInfoForm" modelAttribute="areaCleanInfo">
                 	<div class="modal-body">
						...
						<input type="hidden" id="agent" name="agentId" value=""/>
	             	    <select  id="agent_id" name="" onchange="expDateSetup(this.value,'exp_date','agent')" class="js-example-theme-single form-control" style="width: 100%;" required="required">
                            ...
                            <div class="col-md-3">
                            <div class="form-group">
                                <input type="text" id="cleaning_equipment" name="cleaningEquipment" value="" class="form-control" style="width: 100%;" autocomplete="off" required="required">
                           	</div>
							     	<%-- <div class="form-group">
                 		...
                 		<div class="row">
                            ...
                            <div class="col-md-3">
                            <div class="form-group">
                                <input type="text" id="start_time" name="startTime" value="" class="form-control" style="width: 80%;" autocomplete="off">
                           	</div>
                            </div>
                            ...
                            <div class="col-md-3">
                            <div class="form-group">
                              <input type="text" id="end_time" name="endTime" value="" class="form-control" style="width: 80%;" autocomplete="off" required="required" />
                            </div>
                            </div>
                 		</div>
                 		<div class="row">
                            ...
                            <div class="col-md-3">
                            <div class="form-group">
                                <input type="text" id="cleaning_date" name="cleaningDate" value="" class="form-control" style="width: 80%;" autocomplete="off" required="required">
                           	</div>
                            </div>
	                 		
	                 		<div class="col-md-3 align-right top">
                            	<label for="exp_date">Expiry Date of Cleaning Agent:</label>
                            </div>
                            <div class="col-md-3">
                            <div class="form-group">
                                <input type="text" id="exp_date" name="cleaningExpDate" value="" class="form-control" style="width: 80%;" autocomplete="off" required="required">
                           	</div>
                            </div>
                 		</div>
...
function add(el) {
	...
	$("#cleaning_equipment").val("");
	$("#clean_by").val("").trigger('change.select2');
	
	
	$("#start_time").val("");
	$("#end_time").val("");
	$('#cleaning_date').datepicker('setDate', new Date());
...
function edit(el) {
	...
	var cleaningEquip = $(el).closest("tr").find("#r_cleaning_equipment_id").val();
	...
	$("#cleaning_equipment").val(cleaningEquip);
...
$("#areaCleanInfoForm").submit(function(event){
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_chemi/saveAreaCleanInfos",
	        type: 'POST',
	        data: formData,
	        async: false,
