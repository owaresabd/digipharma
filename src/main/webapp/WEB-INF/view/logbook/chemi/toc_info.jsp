...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">LOGBOOK:: TOTAL ORGANIC CARBON (TOC) ANALYZER</span>
					...
					<table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="typeList">
						<thead>
							<tr>
								...
								<th class="align-center" style="width: 100px;">NAME OF THE SAMPLE</th>
						...
						<tbody>
							...
							<tr>
								...
								<td class="align-center">${info.result}</td>
								...
								<td class="align-center">
									...
									<input type="hidden" id="r_sample_name_id" value="${info.sampleName}">
...
<div class="modal fade" id="deHumidifierInfoModal" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false">
         <div class="modal-dialog modal-lg" role="document">
             ...
             <div class="modal-header bg-cyan" >
                 	...
                 	<td rowspan="3" class="text-center font-bold" style="font-size: 16px !important">Log Book::Total Organic Carbon (TOC) Analyzer</td>
                 	<td style="width:90px">Document No.</td>
                 	<td colspan="2" style="width:110px">LB-DIL-CM-050</td>
                 	</tr>
                 	...
                 	<td colspan="2">28 MAR 2020</td>
                 	</tr>             	
                 	</tbody>
                 	</table>
                   
                 </div>
                 <form method="post" id="tocInfoForm" onkeypress="if (event.keyCode == 13) { return false; }">
                 	...
                 	<div class="row">
                            ...
                            <div class="col-md-4">
                           	...
                           	<input type="text" id="sample_name" name="sampleName" value="" class="form-control" style="width: 100%;" autocomplete="off" >
                            ...
                            <div class="col-md-4">
                            <div class="form-group">
                                <input type="text" id="result" name="result" value="" class="form-control" style="width: 30%;" autocomplete="off" required="required">
                           	</div>
                            </div>
                 		</div>
...
function edit(el) {
	...
	var sampleName = $(el).closest("tr").find("#r_sample_name_id").val();
...
$("#tocInfoForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#tocInfoForm").serialize();
    swal({
        title: "Are you sure?",
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_chemi/saveToc",
	        type: 'POST',
	        data: formData,
	        async: false,
