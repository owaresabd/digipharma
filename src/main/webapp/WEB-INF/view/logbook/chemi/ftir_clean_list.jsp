...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">FTIR CLEAN INFO</span>
		
	</div>
		   <form method="post" id="ftirCleanForm" onkeypress="if (event.keyCode == 13) { return false; }">
					...
					<table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="verifyTable">
						...
						<tbody>
							...
							<tr>
								...
								<td class="align-center">${info.operateByName}</td>
								<td class="align-center">
...
$("#ftirCleanForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#ftirCleanForm").serialize();
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_chemi/cleanFtir",
	        type: 'POST',
	        data: formData,
	        async: false,
