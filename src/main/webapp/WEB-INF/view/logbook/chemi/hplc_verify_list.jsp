...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">HPLC VERIFY INFO</span>
		   ...
		   <form method="post" id="hplcUpdateForm" onkeypress="if (event.keyCode == 13) { return false; }">
...
$("#hplcUpdateForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#hplcUpdateForm").serialize();
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_chemi/verifyHplc",
	        type: 'POST',
	        data: formData,
	        async: false,
