...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">LABORATORY HEATER CLEAN INFO</span>
		
	</div>
		   <form method="post" id="labHeaterForm" onkeypress="if (event.keyCode == 13) { return false; }">
...
$("#labHeaterForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#labHeaterForm").serialize();
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_chemi/cleanLaboratoryHeater",
	        type: 'POST',
	        data: formData,
	        async: false,
