...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">MOISTURE ANALYZER CLEAN INFO</span>
		   ...
		   <form method="post" id="moistureCleanForm" onkeypress="if (event.keyCode == 13) { return false; }">
...
$("#moistureCleanForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#moistureCleanForm").serialize();
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_chemi/cleanMoistureAnalyzer",
	        type: 'POST',
	        data: formData,
	        async: false,
