...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">DISINTEGRATION TEST INFO</span>
		
	</div>
		   <form method="post" id="disIntVerifyForm" onkeypress="if (event.keyCode == 13) { return false; }">
...
$("#disIntVerifyForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#disIntVerifyForm").serialize();
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_chemi/verifyDisintegrationTest",
	        type: 'POST',
	        data: formData,
	        async: false,
