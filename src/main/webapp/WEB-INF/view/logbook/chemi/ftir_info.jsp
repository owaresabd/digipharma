...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">FTIR LOGBOOK INFO</span>
...
<div class="modal fade" id="ftirLogInfoModal" style="overflow: auto;" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false">
         <div class="modal-dialog  modal-lg" role="document">
             ...
             <div class="modal-header bg-cyan" >
                 	...
                 	<td rowspan="3" class="text-center font-bold" style="font-size: 16px !important">Form: FTIR Logbook Info </td>
                 ...
                 <form method="post" id="ftirLogInfoForm" modelAttribute="ftirLogInfo">
...
$("#ftirLogInfoForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#ftirLogInfoForm").serialize();
    swal({
        title: "Are you sure?",
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_chemi/saveFtirInfos",
	        type: 'POST',
	        data: formData,
	        async: false,
	        success: function (data) {
	        	$("#ftirLogInfoModal").modal('hide');
