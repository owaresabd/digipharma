...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">MELTING POINT APPARATUS CLEAN INFO</span>
		
	</div>
		   <form method="post" id="meltingPointForm" onkeypress="if (event.keyCode == 13) { return false; }">
...
$("#meltingPointForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#meltingPointForm").serialize();
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_chemi/cleanMeltingPoint",
	        type: 'POST',
	        data: formData,
	        async: false,
