			...
			<div class="card ">
				<div class="body">
					...
					<div class="row">
						...
						<div class="col-md-3">
                           	<select id="equipment_id" class="js-example-theme-single form-control" onchange="getBiochemicalOxygenCleanPendingInfos()" style="width: 100%;">
...
setTimeout(function() {
      getBiochemicalOxygenCleanPendingInfos();
    }, 2);
});	 
...
function getBiochemicalOxygenCleanPendingInfos(){
    var equipmentId = $('#equipment_id option:selected').val();
	var ajaxURL = "${pageContext.request.contextPath}/logbook_chemi/getBiochemicalOxygenCleanPendingInfos?equipmentId="+equipmentId;
		$.ajax({
			async : false,
			url : ajaxURL ,
