...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">MOISTURE LOGBOOK INFO</span>
	</div>
...
<div class="modal fade" id="moistureAnaInfoModal" style="overflow: auto;" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false">
         <div class="modal-dialog modal-lg" role="document">
             ...
             <div class="modal-header bg-cyan" >
                 	...
                 	<td rowspan="3" class="text-center font-bold" style="font-size: 16px !important">Form: Moisture Analyzer Logbook Info </td>
                 	<td style="width:90px">Document No.</td>
                 	<td colspan="2">LB-DIL-CM-029</td>
                 	</tr>
                 	...
                 	<td colspan="2">01 DEC 2019</td>
                        ...
                        <form method="post" id="mositureAnalyzerInfoForm" modelAttribute="multiParameterInfo">
...
$("#mositureAnalyzerInfoForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#mositureAnalyzerInfoForm").serialize();
    swal({
        title: "Are you sure?",
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_chemi/saveMoistureAnalyzerInfos",
	        type: 'POST',
	        data: formData,
	        async: false,
	        success: function (data) {				 
	        	$("#moistureAnaInfoModal").modal('hide');
