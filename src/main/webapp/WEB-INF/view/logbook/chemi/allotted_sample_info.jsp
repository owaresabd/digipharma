						...
						<tbody>
							...
							<tr>
								...
								<td class="align-center">
									 ...
									 <input type="hidden" id="r_product_id" value="${info.productName}">
									 <input type="hidden" id="r_test_method_id" value="${info.testMethodName}">
...
<div class="modal fade" id="alloteeSampleModal" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false">
         <div class="modal-dialog modal-lg" role="document">
             ...
             <div class="modal-header bg-cyan" >
                 	...
                 	<td colspan="2" style="width:110px">LB-DIL-CM-024</td>
                 	</tr>
                 	...
                 	<div class="modal-body">
                 		...
                 		<div class="row">
						   ...
						   <div class="row">
                            ...
                            <div class="col-md-4">
	                            <div class="form-group">
	                            <input type="text" id="test_method_name" name="testMethodName" value="" class="form-control"  autocomplete="off" required="required">
...
function edit(el) {
	...
	var productName = $(el).closest("tr").find("#r_product_id").val();
	var testMethodName = $(el).closest("tr").find("#r_test_method_id").val();
	...
	$("#test_method_name").val(testMethodName);
...
$("#alloteeSampleInfoForm").submit(function(event){
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_chemi/saveAllottedSample",
	        type: 'POST',
	        data: formData,
	        async: false,
