...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">TEMPERATURE & HUMIDITY RECORD INFO</span>
		
	</div>
		   <form method="post" id="TempHumidityRecordUpdateForm" onkeypress="if (event.keyCode == 13) { return false; }">
					...
					<table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="verifyTable">
						<thead>
							<tr>
								...
								<td class="align-center" style="width: 100px;" rowspan="2">EQUIPMENT ID</td>
								<td class="align-center" style="width: 100px;" rowspan="2">DEPARTMENT</td>
								<td class="align-center" style="width: 100px;" rowspan="2">LOCATION</td>
						...
						<tbody>
							...
							<tr>
								...
								<td class="align-left"><input type="text" name="remarks[]" id="" value="${info.remarks}"></td>
...
$("#TempHumidityRecordUpdateForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#TempHumidityRecordUpdateForm").serialize();
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_chemi/verifyTempHumidityRecord",
	        type: 'POST',
	        data: formData,
	        async: false,
