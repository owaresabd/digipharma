...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">DISINTEGRATION TEST LOGBOOK INFO</span>
	</div>
...
$("#disINtegrationAnalyzerInfoForm").submit(function(event){
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_chemi/saveDisintegrationTestInfos",
	        type: 'POST',
	        data: formData,
	        async: false,
