...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">DE-HUMIDIFIER VERIFY INFO</span>
		
	</div>
		   <form method="post" id="deHumidifierUpdateForm" onkeypress="if (event.keyCode == 13) { return false; }">
...
$("#deHumidifierUpdateForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#deHumidifierUpdateForm").serialize();
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_chemi/verifyDeHumidifier",
	        type: 'POST',
	        data: formData,
	        async: false,
