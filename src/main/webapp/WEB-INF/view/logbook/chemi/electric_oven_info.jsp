...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">ELECTRIC OVEN INFO</span>
					...
					<table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="typeList">
						<thead>
							<tr>
								...
								<th class="align-center" style="width: 180px;">DATE</th>
								<th class="align-center" style="width: 180px;">AR. NO.</th>
								<th class="align-center" style="width: 180px;">EQUIPMENT ID</th>
...
<div class="modal fade" id="electricOvenLogInfoModal" style="overflow: auto;" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false">
         <div class="modal-dialog  modal-lg" role="document">
             ...
             <div class="modal-header bg-cyan" >
                 	...
                 	<td rowspan="3" class="text-center font-bold" style="font-size: 16px !important">Log Book: Electric Oven </td>
                 	<td style="width:90px">Document No.</td>
                 	<td colspan="2" style="width:120px">LB-DIL-CM-017</td>
                 	</tr>
                 ...
                 <form method="post" id="electricOvenLogInfoForm" modelAttribute="electricOvenLogInfo">
                 	<div class="modal-body">
                 		...
                 		<div class="row">
                            ...
                            <div class="col-md-4">
                            <div class="form-group">
                                <input type="text" id="temperature" name="temperature" value="" class="form-control" style="width: 30%;" autocomplete="off" required="required">
                           	</div>
                            </div>
                 			</div>
                 		<div class="row">
...
$(document).ready(function(){
    $('input.setStartTime').mdtimepicker({
      defaultTime: '09:00 AM',
      dynamic: false,
      dropdown: true,
      scrollbar: true,
...
function add(el) {
	...
	$("#remarks").val("");
    $("#electricOvenLogInfoModal").modal();
...
$("#electricOvenLogInfoForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#electricOvenLogInfoForm").serialize();
    swal({
        title: "Are you sure?",
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_chemi/saveElectricOvenInfos",
	        type: 'POST',
	        data: formData,
	        async: false,
	        success: function (data) {
	        	$("#electricOvenLogInfoModal").modal('hide');
...
function printReport(el) {
	var ajaxURL = "${pageContext.request.contextPath}/logbook_chemi/electric-oven-print";
