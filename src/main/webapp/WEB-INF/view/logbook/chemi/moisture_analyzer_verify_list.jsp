...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">MOISTURE ANALYZER INFO</span>
		
	</div>
		   <form method="post" id="moisVerifyForm" onkeypress="if (event.keyCode == 13) { return false; }">
...
$("#moisVerifyForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#moisVerifyForm").serialize();	
    swal({
        title: "Are you sure?",
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_chemi/verifyMoistureAnalyzer",
	        type: 'POST',
	        data: formData,
	        async: false,
