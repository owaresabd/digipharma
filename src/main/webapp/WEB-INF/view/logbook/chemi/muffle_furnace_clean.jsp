			...
			<div class="card ">
				<div class="body">
					...
					<div class="row">
						...
						<div class="col-md-3">
                           	<select id="equipment_id" class="js-example-theme-single form-control" onchange="getMuffleFurnaceCleanPendingInfos()" style="width: 100%;">
...
setTimeout(function() {
      getMuffleFurnaceCleanPendingInfos();
    }, 2);
});	 
...
function getMuffleFurnaceCleanPendingInfos(){
    var equipmentId = $('#equipment_id option:selected').val();
	var ajaxURL = "${pageContext.request.contextPath}/logbook_chemi/getMuffleFurnaceCleanPendingInfos?equipmentId="+equipmentId;
		$.ajax({
			async : false,
			url : ajaxURL ,
