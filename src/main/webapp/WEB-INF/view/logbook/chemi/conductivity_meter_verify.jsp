...
<div class="container-fluid">
	<div class="block-header">
		<span style="text-shadow: 2px 2px 2px #aaa;">CONDUCTIVITY METER VERIFY INFO</span>
...
function getConductivityMeterVerifiedPendingInfos(){
	...
	var ajaxURL = "${pageContext.request.contextPath}/logbook_chemi/getConductivityMeterVerifiedPendingInfos?equipmentId="+equipmentId;
		$.ajax({
			async : false,
			url : ajaxURL ,
