...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">VERIFICATION OF DISSOLUTION MACHINE VERIFT LIST</span>
		
	</div>
		   <form method="post" id="dryCabinetForm" onkeypress="if (event.keyCode == 13) { return false; }">
...
$("#dryCabinetForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#dryCabinetForm").serialize();
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_chemi/verifyVerificationDissolution",
	        type: 'POST',
	        data: formData,
	        async: false,
