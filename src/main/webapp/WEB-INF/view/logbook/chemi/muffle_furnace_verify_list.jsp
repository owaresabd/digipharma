...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">BIOLOGICAL SAFETY INFO</span>
		
	</div>
		   <form method="post" id="muffleFurnaceUpdateForm" onkeypress="if (event.keyCode == 13) { return false; }">
...
$("#muffleFurnaceUpdateForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#muffleFurnaceUpdateForm").serialize();
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_chemi/verifyMuffleFurnace",
	        type: 'POST',
	        data: formData,
	        async: false,
