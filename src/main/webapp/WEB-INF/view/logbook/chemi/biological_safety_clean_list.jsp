...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">BIOLOGICAL SAFETY CLEAN INFO</span>
		   ...
		   <form method="post" id="biologicalSafetyForm" onkeypress="if (event.keyCode == 13) { return false; }">
...
$("#biologicalSafetyForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#biologicalSafetyForm").serialize();
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_chemi/cleanBiologicalSafety",
	        type: 'POST',
	        data: formData,
	        async: false,
