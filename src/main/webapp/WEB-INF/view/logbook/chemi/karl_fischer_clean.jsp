			...
			<div class="card ">
				<div class="body">
					...
					<div class="row">
						...
						<div class="col-md-3">
                           	<select id="equipment_id" class="js-example-theme-single form-control" onchange="getKarlFischerCleanPendingInfos()" style="width: 100%;">
...
setTimeout(function() {
      getKarlFischerCleanPendingInfos();
    }, 2);
});	 
...
function getKarlFischerCleanPendingInfos(){
    var equipmentId = $('#equipment_id option:selected').val();
	var ajaxURL = "${pageContext.request.contextPath}/logbook_chemi/getKarlFischerCleanPendingInfos?equipmentId="+equipmentId;
		$.ajax({
			async : false,
			url : ajaxURL ,
