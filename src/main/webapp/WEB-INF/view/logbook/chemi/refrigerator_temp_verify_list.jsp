...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;"> REFRIGERATOR TEMPERATURE RECORD LIST</span>
...
$("#tempRefrigBathVerifyForm").submit(function(event){
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_chemi/verifyRefrigeratorTemp",
	        type: 'POST',
	        data: formData,
	        async: false,
