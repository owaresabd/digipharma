...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">VACUUM PUMP VERIFY INFO</span>
					...
					<table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="verifyTable">
						<thead>
							<tr>
								...
								<th class="align-center">PURPOSE OF USE</th>
						...
						<tbody>
							<c:forEach var="info" items="${vacuumPumpInfos}" varStatus="counter">
							<tr>
...
$("#waterPurificationUpdateForm").submit(function(event){
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_chemi/verifyVaccumPump",
	        type: 'POST',
	        data: formData,
	        async: false,
