...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">MELTING POINT APPARATUS INFO</span>
		
	</div>
		   <form method="post" id="meltingPointUpdateForm" onkeypress="if (event.keyCode == 13) { return false; }">
...
$("#meltingPointUpdateForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#meltingPointUpdateForm").serialize();
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_chemi/verifyMeltingPoint",
	        type: 'POST',
	        data: formData,
	        async: false,
