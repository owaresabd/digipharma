...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">ALLOTTED SAMPLE FOR ANALYST VALIDATION VERIFY INFO</span>
		
	</div>
		   <form method="post" id="allotteSampleUpdateForm" onkeypress="if (event.keyCode == 13) { return false; }">
...
$("#allotteSampleUpdateForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#allotteSampleUpdateForm").serialize();
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_chemi/verifyAllottedSample",
	        type: 'POST',
	        data: formData,
	        async: false,
