...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">LOGBOOK:: WATER SAMPLING</span>
...
<div class="modal fade" id="waterPurificationInfoModal" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false">
         <div class="modal-dialog modal-lg" role="document">
             ...
             <div class="modal-header bg-cyan" >
                 	...
                 	<td colspan="2" style="width:110px">LB-DIL-GN-021</td>
                 	</tr>
...
$("#waterPurificationInfoForm").submit(function(event){
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_chemi/saveWaterSampling",
	        type: 'POST',
	        data: formData,
	        async: false,
