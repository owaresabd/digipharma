...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">COLUMN PERFORMANCE RECORD LOGBOOK INFO</span>
	 ...
	 <form method="post" id="columnPerformanceVerifyForm" onkeypress="if (event.keyCode == 13) { return false; }">
					...
					<table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="typeList">
						<thead>
							<tr>
								...
								<th class="align-center" style="width: 100px;"><span class="input-group-addon">
						...
						<tbody>
							...
							<tr>
								...
								<td class="align-center"><input type="text" name="remarks[]" id="" value="${info.remarks}"></td>
								<td class="align-center">
    ...
    <div class="modal fade" id="columnRcvDistIssueModal" style="overflow: auto;" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false">
         <div class="modal-dialog md modal-lg" role="document">
             ...
             <div class="modal-header bg-cyan" >
                 ...
                 <form method="post" id="columnPerformanceRecordForm">
...
function edit(el){	
	...
	var tp		= $(el).closest("tr").find("#r_tp").val();
	var tf		= $(el).closest("tr").find("#r_tf").val();
	var rsd		= $(el).closest("tr").find("#r_rsd").val();
...
$("#columnPerformanceRecordForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#columnPerformanceRecordForm").serialize();
	swal({
        title: "Are you sure?",
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_chemi/updatePerformanceColumnRecord",
	        type: 'POST',
	        data: formData,
	        async: false,
...
$(document).ready(function() {
 $("#checkedAll").change(function() {
	...
	$("#columnPerformanceVerifyForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#columnPerformanceVerifyForm").serialize();
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_chemi/verifyColumnPerformanceRecord",
	        type: 'POST',
	        data: formData,
	        async: false,
			success : function(data) {
