...
<div class="container-fluid">
	<div class="block-header">
		<span style="text-shadow: 2px 2px 2px #aaa;">KARL FISCHER VERIFY INFO</span>
			...
			<div class="card ">
				<div class="body">
					...
					<div class="row">
						...
						<div class="col-md-3">
                           	<select id="equipment_id" class="js-example-theme-single form-control" onchange="getKarlFischerVerifiedPendingInfos()" style="width: 100%;">
...
setTimeout(function() {
      getKarlFischerVerifiedPendingInfos();
    }, 2);
});	 
...
function getKarlFischerVerifiedPendingInfos(){
    var equipmentId = $('#equipment_id option:selected').val();
	var ajaxURL = "${pageContext.request.contextPath}/logbook_chemi/getKarlFischerVerifiedPendingInfos?equipmentId="+equipmentId;
		$.ajax({
			async : false,
			url : ajaxURL ,
