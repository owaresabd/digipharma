					...
					<table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="typeList">
						<thead>
							<tr>
								...
								<th class="align-center" style="width: 100px;">Q.C REF NO</th>
								<th class="align-center" style="width: 100px;">QTY</th>
								<th class="align-center" style="width: 110px;">DATE (In Chamber)</th>
								<th class="align-center" style="width: 100px;">DISCARDED BY</th>
						...
						<tbody>
							...
							<tr>
								...
								<td class="align-left">${info.discardByName}</td>
								...
								<td class="align-center">
									...
									<input type="hidden" id="r_in_date" value="${info.inDate}">
									<input type="hidden" id="r_out_date" value="${info.outDate}">
									<input type="hidden" id="r_discard_date" value="${info.discardDate}">
									<input type="hidden" id="r_qty" value="${info.qty}">
									<input type="hidden" id="r_discard_qty" value="${info.discardQty}">
									<input type="hidden" id="r_discard_by" value="${info.discardBy}">
                 ...
                 <form method="post" id="refrigeratorInfoForm" modelAttribute="refrigeratorInfo">
                 	<div class="modal-body">
                 		...
                 		<div class="row">
                            ...
                            <div class="col-md-4">
                           	<div class="form-group">
                                <select onchange="sampleInfoById(this.id)" id="sample_name_id" name="sampleNameId" class="js-example-theme-single form-control" style="width: 100%;" required="required">
                 		...
                 		<div class="row">
                            ...
                            <div class="col-md-4">
                            <div class="form-group">
                                <input type="text" id="qty" name="qty" value="" class="form-control" style="width: 30%;" autocomplete="off" required="required">
                           	</div>
                            </div>
                 		</div>
                 		<div class="row">
	                 		<div class="col-md-2 align-right top">
                            	<label for="in_date">Date, Keep In Chamber :</label>
                            </div>
                            <div class="col-md-4">
                            <div class="form-group">
                                <input type="text" id="in_date" name="inDate" value="" class="form-control" style="width: 30%;" autocomplete="off" required="required">
                           	</div>
                            </div>
                            
                            <div class="col-md-2 align-right top">
                            	<label for="out_date">Date, Keep Out From Chamber :</label>
                            </div>
                            <div class="col-md-4">
                            <div class="form-group">
                                <input type="text" id="out_date" name="outDate" value="" class="form-control" style="width: 30%;" autocomplete="off" required="required">
                           	</div>
                            </div>
                 		</div>
                 		<div class="row">
	                 		<div class="col-md-2 align-right top">
                            	<label for="discard_qty">Discarded Qty :</label>
                            </div>
                            <div class="col-md-4">
                            <div class="form-group">
                                <input type="text" id="discard_qty" name="discardQty" value="" class="form-control" style="width: 30%;" autocomplete="off" required="required">
                           	</div>
                            </div>
	                 		
	                 		<div class="col-md-2 align-right top">
                            	<label for="discard_by">Discarded By :</label>
                            </div>
                            <div class="col-md-4">
                           	<div class="form-group">
                                <select  id="discard_by" name="discardBy" class="js-example-theme-single form-control" style="width: 100%;">
                 		...
                 		<div class="row">
	                 		<div class="col-md-2 align-right top">
                            	<label for="discard_date">Discarded Date :</label>
                            </div>
                            <div class="col-md-4">
                            <div class="form-group">
                                <input type="text" id="discard_date" name="discardDate" value="" class="form-control" style="width: 30%;" autocomplete="off" required="required">
                           	</div>
                            </div>
...
function add(el) { 
	...
	$("#qty").val("");
	$('#in_date').datepicker('setDate', new Date());
	$('#out_date').datepicker('setDate', '');
	$('#discard_date').datepicker('setDate', new Date());
	$("#discard_qty").val("");
	$("#discard_by").val("").trigger('change.select2');
...
$("#refrigeratorInfoForm").submit(function(event){
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_chemi/saveRefrigeratorInfos",
	        type: 'POST',
	        data: formData,
	        async: false,
...
function printReport(el) {
	var ajaxURL = "${pageContext.request.contextPath}/logbook_chemi/refrigerator-log-print";
