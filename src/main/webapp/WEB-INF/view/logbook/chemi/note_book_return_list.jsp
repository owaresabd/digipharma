...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">NOTE BOOK RETURN INFO</span>
		
	</div>
		   <form method="post" id="noteBookVerifyForm" onkeypress="if (event.keyCode == 13) { return false; }">
					...
					<table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="verifyTable">
						<thead>
							<tr>
							    ...
							    <th class="align-center" style="width: 110px;">RECEIVED BY</th>
...
$("#noteBookVerifyForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#noteBookVerifyForm").serialize();
	
	
    swal({
        title: "Are you sure?",
        text: "You will return selected data!",
        type: "warning",
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_chemi/noteBookReturn",
	        type: 'POST',
	        data: formData,
	        async: false,
