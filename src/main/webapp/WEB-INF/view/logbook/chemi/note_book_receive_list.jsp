...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">NOTE BOOK RECEIVE INFO</span>
		
	</div>
		   <form method="post" id="receiveNoteBookForm" onkeypress="if (event.keyCode == 13) { return false; }">
...
$("#receiveNoteBookForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#receiveNoteBookForm").serialize();
	
	
    swal({
        title: "Are you sure?",
        text: "You will receive selected data!",
        type: "warning",
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_chemi/receiveNoteBook",
	        type: 'POST',
	        data: formData,
	        async: false,
