...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;"> DATA BACKUP LIST</span>
		
	</div>
		   <form method="post" id="tempRefrigBathVerifyForm" onkeypress="if (event.keyCode == 13) { return false; }">
...
$("#tempRefrigBathVerifyForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#tempRefrigBathVerifyForm").serialize();
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_chemi/verifyDataBackup",
	        type: 'POST',
	        data: formData,
	        async: false,
