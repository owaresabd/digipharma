...
<div class="container-fluid">
	<div class="block-header">
		<span style="text-shadow: 2px 2px 2px #aaa;"> VACUUM PUMP REPORT</span>
	</div>
...
function printReport(el) {
    ...
    var ajaxURL = "${pageContext.request.contextPath}/logbook_chemi/refrigerator-log-print?id="+ id+ "&fromDate=" + fromDate+ "&toDate=" + toDate;
	 $.ajax({
		type : "GET",
		url : ajaxURL,
		dataType : 'json',
