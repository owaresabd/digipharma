...
<div class="container-fluid">
	<div class="block-header">
		<span style="text-shadow: 2px 2px 2px #aaa;">ANALYTICAL BALANCE VERIFY INFO</span>
			...
			<div class="card ">
				<div class="body">
					...
					<div class="row">
						...
						<div class="col-md-3">
                           	<select id="equipment_id" class="js-example-theme-single form-control" onchange="getAnalyticalBalanceVerifiedPendingInfos()" style="width: 100%;">
...
setTimeout(function() {
      getAnalyticalBalanceVerifiedPendingInfos();
    }, 2);
});	 
...
function getAnalyticalBalanceVerifiedPendingInfos(){
    var equipmentId = $('#equipment_id option:selected').val();
	var ajaxURL = "${pageContext.request.contextPath}/logbook_chemi/getAnalyticalBalanceVerifiedPendingInfos?equipmentId="+equipmentId;
		$.ajax({
			async : false,
			url : ajaxURL ,
