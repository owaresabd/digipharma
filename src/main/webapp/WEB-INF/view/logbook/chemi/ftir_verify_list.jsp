...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">FTIR INFO</span>
		
	</div>
		   <form method="post" id="ftirVerifyForm" onkeypress="if (event.keyCode == 13) { return false; }">
					...
					<table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="verifyTable">
						<thead>
							<tr>
								...
								<th class="align-center" style="width: 110px;">LOT NO</th>
								<th class="align-center" style="width: 110px;">DONE</th>
								<th class="align-center" style="width: 110px;">CLEAN BY</th>
...
$("#ftirVerifyForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#ftirVerifyForm").serialize();
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_chemi/verifyFtir",
	        type: 'POST',
	        data: formData,
	        async: false,
