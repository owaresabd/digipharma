...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">TEMP REFRIGERATOR LOGBOOK INFO</span>
					...
					<table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="typeList">
						<thead>
							<tr>
								...
								<th class="align-center" style="width: 100px;">TEMP</th>
						...
						<tbody>
							...
							<tr>
								...
								<td class="align-center">${info.temparature}</td>
...
<div class="modal fade" id="refrigeratorLogInfoModal" style="overflow: auto;" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false">
         <div class="modal-dialog" role="document">
             ...
             <div class="modal-header bg-cyan" >
                 	...
                 	<td rowspan="3" class="text-center font-bold" style="font-size: 16px !important">Form: Temp Refrigerator Logbook Info </td>
                 	<td style="width:90px">Document No.</td>
                 	<td colspan="2" style="width:120px">LB-DIL-CM-029</td>
                 	</tr>
                 ...
                 <form method="post" id="refrigeratorLogInfoForm" modelAttribute="refrigeratorLogInfo">
                 	<div class="modal-body">
                 		<div class="alert-code alert-block alert-danger hidden"></div><br>
                 		<input type="hidden" id="id" name="id" value=""/>
                 		<div class="row">
	                 		<div class="col-md-4 align-right top">
                            	<label for="service_item">TEMPERATURE :</label>
                            </div>
                            <div class="col-md-8">
                            <div class="form-group">
                                <input type="text" id="temparature" name="temparature" value="" class="form-control" style="width: 30%;" autocomplete="off" required="required">
                           	</div>
                            </div>
                 		</div>
                 		<div class="row">
                 		...
                 		<div class="row">
	                 		<div class="col-md-4 align-right top">
                            	<label for="service_type">TIME OF BACKUP :</label>
                            </div>
                            <div class="col-md-8">
                            <div class="form-group">
                 		...
                 		<div class="row">
	                 		<div class="col-md-4 align-right top">
                            	<label for="service_item">CHECKED BY :</label>
                            </div>
                            <div class="col-md-8">
                           	<div class="form-group">
                                <select  id="cheked_by" name="chekedBy" class="js-example-theme-single form-control" style="width: 100%;" required="required">
...
function add(el) {
	...
	$("#record_time").val("");
	$("#cheked_by").val("").trigger('change.select2');
	$("#verify_by").val("").trigger('change.select2');
	$("#remarks").val("");
    $("#refrigeratorLogInfoModal").modal();
...
$("#refrigeratorLogInfoForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#refrigeratorLogInfoForm").serialize();
    swal({
        title: "Are you sure?",
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_chemi/saveTempRefrigeratorInfos",
	        type: 'POST',
	        data: formData,
	        async: false,
	        success: function (data) {				 
	        	$("#refrigeratorLogInfoModal").modal('hide');
...
function printReport(el) {
	var ajaxURL = "${pageContext.request.contextPath}/logbook_chemi/temp-refrigerator-log-print";
