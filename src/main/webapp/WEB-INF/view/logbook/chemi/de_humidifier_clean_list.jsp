...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">LOGBOOK:: DE-HUMIDIFIER CLEAN LIST</span>
					...
					<table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="typeList">
						<thead>
							<tr>
								...
								<th class="align-center" style="width: 100px;">CLEAN TIME</th>
...
<div class="modal fade" id="deHumidifierInfoModal" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false">
         <div class="modal-dialog modal-lg" role="document">
             ...
             <div class="modal-header bg-cyan" >
                 	...
                 	<td rowspan="3" class="text-center font-bold" style="font-size: 16px !important">Log Book::De-Humidifier</td>
                 	<td style="width:90px">Document No.</td>
                 	<td colspan="2" style="width:110px">LB-DIL-CM-051</td>
                 	</tr>
                 	...
                 	<td colspan="2">20 MAR 2020</td>
                 	</tr>             	
                 	</tbody>
                 	</table>
                   
                 </div>
                 <form method="post" id="deHumidityInfoForm" onkeypress="if (event.keyCode == 13) { return false; }">
                 	...
                 	<div class="modal-body">
                 		...
                 		<div class="row">
                            ...
                            <div class="col-md-10 m-t-15">
                            	<div class="form-group">
                                	<textarea rows="2" id="remarks" name="remarks" class="form-control" readonly="readonly" placeholder="Description goes here......." ></textarea>
	                            </div>
                            </div>
                 		</div>
...
$("#deHumidityInfoForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#deHumidityInfoForm").serialize();
    swal({
        title: "Are you sure?",
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_chemi/cleanDeHumidifier",
	        type: 'POST',
	        data: formData,
	        async: false,
