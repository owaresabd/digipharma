...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">SONICATOR BATH  INFO LIST</span>
		
	</div>
		   <form method="post" id="sonicatorBathVerifyForm" onkeypress="if (event.keyCode == 13) { return false; }">
...
$("#sonicatorBathVerifyForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#sonicatorBathVerifyForm").serialize();
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_chemi/verifySonicatorBath",
	        type: 'POST',
	        data: formData,
	        async: false,
