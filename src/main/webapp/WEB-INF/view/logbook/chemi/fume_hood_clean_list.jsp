...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">FUME HOOD CLEAN INFO</span>
		   ...
		   <form method="post" id="fumeHoodForm" onkeypress="if (event.keyCode == 13) { return false; }">
...
$("#fumeHoodForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#fumeHoodForm").serialize();
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_chemi/cleanFumeHood",
	        type: 'POST',
	        data: formData,
	        async: false,
