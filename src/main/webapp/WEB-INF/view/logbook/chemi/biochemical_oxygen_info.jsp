...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">LOG BOOK:: BIOCHEMICAL OXYGEN DEMAND(BOD) INFO</span>
					...
					<table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="typeList">
						<thead>
							<tr>
								...
								<th class="align-center" style="width: 100px;">START DATE</th>
								<th class="align-center" style="width: 100px;">START TIME</th>
								<th class="align-center" style="width: 110px;">EQUIPMENT ID</th>
								<th class="align-center" style="width: 180px;">NAME OF SAMPLE</th>
								<th class="align-center" style="width: 100px;">END DATE</th>
						...
						<tbody>
							...
							<tr>
								...
								<td class="align-center"><fmt:formatDate var="startDate" value="${info.startDate}" pattern="dd-MMM-yyyy"/>
								${startDate}</td>
								...
								<td class="align-center"><fmt:formatDate var="endDate" value="${info.endDate}" pattern="dd-MMM-yyyy"/>
								${endDate}</td>
								<td class="align-center">${info.endTime}</td>
								<td class="align-left">${info.result}</td>
								...
								<c:choose>
									...
									<input type="hidden" id="r_start_date" value="${info.startDate}">
									<input type="hidden" id="r_end_date" value="${info.endDate}">
...
<div class="modal fade" id="melPointInfoModal" style="overflow: auto;" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false">
         <div class="modal-dialog modal-lg" role="document">
             ...
             <div class="modal-header bg-cyan" >
                 	...
                 	<td rowspan="3" class="text-center font-bold" style="font-size: 16px !important">Log Book :: Biochemical Oxygen Demand (BOD)</td>
                 	<td style="width:90px">Document No.</td>
                 	<td colspan="2" style="width:120px">LB-DIL-CM-044</td>
                 	</tr>
                 ...
                 <form method="post" id="autoPolarimeterInfoForm" >
                 	<div class="modal-body">
                 		...
                 		<input type="hidden" id="id" name="id" value=""/>
                            ...
                            <div class="col-md-4">
                           	<div class="form-group">
                                <select  id="sample_name_id" name="sampleNameId" class="js-example-theme-single form-control" style="width: 100%;" required="required">
                            ...
                            <div class="col-md-4">
                            <div class="form-group">
                                <input type="text" id="start_date" name="startDate" value="" class="form-control" style="width: 30%;" autocomplete="off" required="required">
                           	</div>
                            </div>
                            ...
                            <div class="col-md-4">
                            <div class="form-group">
                                <input type="text" id="end_date" name="endDate" value="" class="form-control" style="width: 30%;" autocomplete="off" required="required">
                           	</div>
                            </div>
                 		</div>
                 	 	 	<div class="row">
                     	...
                     	<div class="row">
                            ...
                            <div class="col-md-4">
                            <div class="form-group">
                                <input type="text" id="result" name="result" value="" class="form-control" style="width: 100%;" autocomplete="off" required="required">
                           	</div>
                            </div>
                 		</div>
...
function edit(el) {
	...
	var startDate 		 = $(el).closest("tr").find("#r_start_date").val();
	var endDate		 = $(el).closest("tr").find("#r_end_date").val();
	...
	$("#remarks").val(remarks);
	$("#result").val(result);
	$('#start_date').datepicker('setDate', convertMmDate(startDate));
	$('#end_date').datepicker('setDate', convertMmDate(endDate));
...
$("#autoPolarimeterInfoForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#autoPolarimeterInfoForm").serialize();
    swal({
        title: "Are you sure?",
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_chemi/saveBiochemicalOxygenInfo",
	        type: 'POST',
	        data: formData,
	        async: false,
	        success: function (data) {
	        	$("#melPointInfoModal").modal('hide');
