...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">BIOCHEMICAL OXYGEN DEMAND(BOD) INFO</span>
		
	</div>
		   <form method="post" id="autoPolarimeterUpdateForm" onkeypress="if (event.keyCode == 13) { return false; }">
					...
					<table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="verifyTable">
						<thead>
							<tr>
								...
								<th class="align-center" style="width: 100px;">CLEAN BY</th>
...
$("#autoPolarimeterUpdateForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#autoPolarimeterUpdateForm").serialize();
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_chemi/verifyBiochemicalOxygen",
	        type: 'POST',
	        data: formData,
	        async: false,
