...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">FILTER CHANGE LOGBOOK INFO</span>
					...
					<table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="typeList">
						<thead>
							<tr>
								...
								<th class="align-center" style="width: 180px;">MAINTENANCE</th>
						...
						<tbody>
							...
							<tr>
								...
								<td class="align-center">${info.maintenName}</td>
								...
								<td class="align-center">
									...
									<input type="hidden" id="r_mainten_type" value="${info.maintenType}">
...
<div class="modal fade" id="filterChangeLogInfoModal" style="overflow: auto;" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false">
         <div class="modal-dialog" role="document">
             ...
             <div class="modal-header bg-cyan" >
                 	...
                 	<td rowspan="3" class="text-center font-bold" style="font-size: 16px !important">Form: Filter Change Logbook Info </td>
                 	<td style="width:90px">Document No.</td>
                 	<td colspan="2" style="width:120px">LB-DIL-CM-012</td>
                 	</tr>
                 ...
                 <form method="post" id="filterChangeLogInfoForm" modelAttribute="filterChangeLogInfo">
                 	<div class="modal-body">
                 		...
                 		<div class="row">
	                 		<div class="col-md-4 align-right top">
                            	<label for="mainten_type">TYPE OF MAINTENANCE :</label>
                            </div>
                            <div class="col-md-8">
                           	<div class="form-group">
                                <select  id="mainten_type" name="maintenType" class="js-example-theme-single form-control" style="width: 100%;" required="required">
			                        <option value="">-Select Maintenance-</option>
			                        <c:forEach var="info" items="${maintenanceTypeInfos}">
...
function edit(el) {
	...
	var maintenType = $(el).closest("tr").find("#r_mainten_type").val();
	...
	$("#id").val(Id);
	$("#mainten_type").val(maintenType).trigger('change.select2');
...
$("#filterChangeLogInfoForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#filterChangeLogInfoForm").serialize();
    swal({
        title: "Are you sure?",
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_chemi/saveFilterChangeInfos",
	        type: 'POST',
	        data: formData,
	        async: false,
	        success: function (data) {
	        	$("#filterChangeLogInfoModal").modal('hide');
...
function printReport(el) {
	var ajaxURL = "${pageContext.request.contextPath}/logbook_chemi/filterchange-log-print";
