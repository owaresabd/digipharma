...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">TOTAL ORGANIC CARBON (TOC) ANALYZER VERIFY INFO</span>
		
	</div>
		   <form method="post" id="tocUpdateForm" onkeypress="if (event.keyCode == 13) { return false; }">
...
$("#tocUpdateForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#tocUpdateForm").serialize();
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_chemi/verifyToc",
	        type: 'POST',
	        data: formData,
	        async: false,
