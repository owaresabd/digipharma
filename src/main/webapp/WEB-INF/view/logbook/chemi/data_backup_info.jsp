					...
					<table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="typeList">
						...
						<tbody>
							...
							<tr>
								...
								<td class="align-center"><fmt:formatDate var="backupDate" value="${info.backupDate}" pattern="dd-MMM-yyyy"/>
								${backupDate}</td>
							<td class="align-left">${info.backupName}</td>
								...
								<td class="align-center">
									...
									<input type="hidden" id="r_instrument_name" value="${info.instrumentName}">
...
<div class="modal fade" id="dissolutionInfoModal" style="overflow: auto;" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false">
         <div class="modal-dialog modal-lg" role="document">
             ...
             <div class="modal-header bg-cyan" >
                 	...
                 	<td rowspan="3" class="text-center font-bold" style="font-size: 16px !important">Log Book: Data Backup</td>
                 	<td style="width:90px">Document No.</td>
                 	<td colspan="2" style="width:120px">LB-DIL-GN-005</td>
                 	</tr>
                 	...
                 	<td colspan="2"><strong>15  OCT 2019</strong></td>
                 	</tr>             	
                 	</tbody>
                 	</table>
                   
                 </div>
                 <form method="post" id="dataBackUpInfoForm" >
                 	...
                 	<div class="row">
                            ...
                            <div class="col-md-4">
								...
								<input type="text" id="instrument_name" name="instrumentName" value="" class="form-control" style="width: 100%;" autocomplete="off" required="required">
...
$("#dataBackUpInfoForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#dataBackUpInfoForm").serialize();
    swal({
        title: "Are you sure?",
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_chemi/saveDataBackupInfo",
	        type: 'POST',
	        data: formData,
	        async: false,
