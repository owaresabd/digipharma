...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">LABORATORY HEATERY INFO</span>
		
	</div>
		   <form method="post" id="labHeaterUpdateForm" onkeypress="if (event.keyCode == 13) { return false; }">
...
$("#labHeaterUpdateForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#labHeaterUpdateForm").serialize();
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_chemi/verifyLaboratoryHeater",
	        type: 'POST',
	        data: formData,
	        async: false,
