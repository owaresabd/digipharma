...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">LOGBOOK:: SAMPLE LABEL CONTROL</span>
					...
					<table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="typeList">
						<thead>
							<tr>
								...
								<th class="align-center" style="width: 100px;">ISSUE  DATE</th>
								<!--<th class="align-center" style="width: 110px;">EQUIPMENT ID</th>-->
								<th class="align-center" style="width: 100px;">NAME OF THE MATERIAL</th>
								<th class="align-center" style="width: 100px;">BATCH NO./CHALLAN NO.</th>
...
<div class="modal fade" id="deHumidifierInfoModal" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false">
         <div class="modal-dialog modal-lg" role="document">
             ...
             <div class="modal-header bg-cyan" >
                 	...
                 	<td rowspan="3" class="text-center font-bold" style="font-size: 16px !important">Log Book:: Sample Label Control</td>
                 	<td style="width:90px">Document No.</td>
                 	<td colspan="2" style="width:110px">LB-DIL-CM-047</td>
                 	</tr>
                 ...
                 <form method="post" id="SampleLabelInfoForm" onkeypress="if (event.keyCode == 13) { return false; }">
                 	...
                 	<div class="row">
                       ...
                       <!-- 		<div class="col-md-2 align-right top">
                            ...
                            <div class="col-md-2">
                            <div class="form-group">
                                <input type="text" id="qty" name="qty" value="" class="form-control" style="width: 100%;" autocomplete="off" required="required">
                           	</div>
                            </div>
			                <div class="col-md-2">
                            <div class="form-group">
...
$("#SampleLabelInfoForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#SampleLabelInfoForm").serialize();
    swal({
        title: "Are you sure?",
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_chemi/saveSampleLabel",
	        type: 'POST',
	        data: formData,
	        async: false,
