...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">REFRACTOMETER INFO</span>
		
	</div>
		   <form method="post" id="refratcometerUpdateForm" onkeypress="if (event.keyCode == 13) { return false; }">
...
$("#refratcometerUpdateForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#refratcometerUpdateForm").serialize();
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_chemi/verifyRefractometer",
	        type: 'POST',
	        data: formData,
	        async: false,
