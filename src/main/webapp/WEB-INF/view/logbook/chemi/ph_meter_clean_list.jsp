...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">PH CLEAN INFO</span>
		
	</div>
		   <form method="post" id="phMeterCleanForm" onkeypress="if (event.keyCode == 13) { return false; }">
...
$("#phMeterCleanForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#phMeterCleanForm").serialize();
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_chemi/cleanPhMeter",
	        type: 'POST',
	        data: formData,
	        async: false,
