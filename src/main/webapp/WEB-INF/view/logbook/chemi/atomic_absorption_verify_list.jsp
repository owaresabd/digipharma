...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">ATOMIC ABSORPTION SPECTROMETER VERIFY INFO</span>
...
$("#SampleLabelUpdateForm").submit(function(event){
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_chemi/verifyAtomicAbsorption",
	        type: 'POST',
	        data: formData,
	        async: false,
