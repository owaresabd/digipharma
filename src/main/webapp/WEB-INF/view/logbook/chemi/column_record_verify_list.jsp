...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">COLUMN RECORD VERIFY INFO</span>
		
	</div>
		   <form method="post" id="columnRecordUpdateForm" onkeypress="if (event.keyCode == 13) { return false; }">
...
$("#columnRecordUpdateForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#columnRecordUpdateForm").serialize();
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_chemi/verifyColumnRecord",
	        type: 'POST',
	        data: formData,
	        async: false,
