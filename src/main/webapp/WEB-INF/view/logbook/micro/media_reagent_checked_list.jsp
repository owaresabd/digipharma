...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">MEDIA,REAGENT AND OTHER MATERIALS RECEVING AND STOCK CONTROL CHECK INFO</span>
					...
					<table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="verifyTable">
						...
						<tbody>
							...
							<tr>
								...
								<td class="align-left"><input type="text" name="remarks[]" id="" style="width:100%" value="${info.remarks}"></td>
...
$("#mediaUpdateForm").submit(function(event){
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_micro/checkedMediaReagentMaterials",
	        type: 'POST',
	        data: formData,
	        async: false,
