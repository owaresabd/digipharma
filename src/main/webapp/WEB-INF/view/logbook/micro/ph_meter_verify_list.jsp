...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">PH VERIFY INFO</span>
		
	</div>
		   <form method="post" id="phMeterUpdateForm" onkeypress="if (event.keyCode == 13) { return false; }">
					...
					<table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="verifyTable">
						<thead>
							<tr>
								...
								<th class="align-center" style="width: 70px;">TIME</th>
								<th class="align-left" style="width: 130px;">EQUIPMENT ID</th>
...
$("#phMeterUpdateForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#phMeterUpdateForm").serialize();
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_micro/verifyPhMeter",
	        type: 'POST',
	        data: formData,
	        async: false,
