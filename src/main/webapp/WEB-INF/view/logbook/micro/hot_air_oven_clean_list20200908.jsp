...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">HOT AIR OVEN CHECK INFO LIST</span>
		
	</div>
		   <form method="post" id="hotAirOvenCheckForm" onkeypress="if (event.keyCode == 13) { return false; }">
...
$("#hotAirOvenCheckForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#hotAirOvenCheckForm").serialize();	
