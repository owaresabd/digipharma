...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">TEMPERATURE INCUBATOR EVENING RECORD LOGBOOK INFO</span>
	</div>
			...
			<div class="card">
				<div class="body table-responsive table-bordered">
					...
					<table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="typeList" style="">
						<thead>
							<tr>
								<td class="align-center" style="width: 50px;" rowspan="3">SL NO</td>
								<td class="align-center" style="width: 120px;" rowspan="3">EQUIPMENT ID</td>
								<td class="align-center" style="width: 80px;" rowspan="3">DATE</td>
						  ...
						  <!--<td class="align-center" colspan="2">MORNING(08:30 AM to 09 :30 AM)</td>
								...
								-->
						  		<td class="align-center" style="width: 80px;" rowspan="3">CLEANED BY</td>
...
$("#TempHumidityRecordForm").submit(function(event){
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_micro/saveTempEveningRecord",
	        type: 'POST',
	        data: formData,
	        async: false,
