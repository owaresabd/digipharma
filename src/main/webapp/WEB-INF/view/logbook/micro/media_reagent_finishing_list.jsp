...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">MEDIA,REAGENT AND OTHER MATERIALS RECEVING AND STOCK CONTROL FINISHING INFO</span>
		
	</div>
		   <form method="post" id="mediaUpdateForm" onkeypress="if (event.keyCode == 13) { return false; }">
...
$("#mediaUpdateForm").submit(function(event){
    ...
    var formData = $("#mediaUpdateForm").serialize();	
	swal({
        title: "Are you sure?",
        text: "You will open selected data!",
        type: "warning",
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_micro/finishMediaReagentMaterials",
	        type: 'POST',
	        data: formData,
	        async: false,
			success : function(data) {
				$("#view_page").html(data);
				sweetAlert("Updated!", "Finished Successfully", "success", 1000, false);
			},
	        error: function(){
