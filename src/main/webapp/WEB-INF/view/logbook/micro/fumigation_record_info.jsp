...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">FUMIGATION RECORD LOGBOOK INFO</span>
					...
					<table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="typeList">
						<thead>
							<tr>
								...
								<th class="align-center" style="width: 180px;">LOCATION</th>
								<th class="align-center" style="width: 100px;">ROOM NO</th>
						...
						<tbody>
							...
							<tr>
								...
								<td class="align-center">${info.location}</td>
								<td class="align-center">${info.roomNo}</td>
								...
								<td class="align-center">
									...
									<input type="hidden" id="r_room_no" value="${info.roomNo}">
									<input type="hidden" id="r_potassium" value="${info.potassium}">
									<input type="hidden" id="r_formal" value="${info.formal}">
...
<div class="modal fade" id="fumigationLogInfoModal" style="overflow: auto;" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false">
         <div class="modal-dialog" role="document">
             ...
             <div class="modal-header bg-cyan" >
                 	...
                 	<td rowspan="3" class="text-center font-bold" style="font-size: 16px !important">Form: Fumigation Record Logbook Info </td>
                 ...
                 <form method="post" id="fumigationLogInfoForm" modelAttribute="fumigationLogInfo">
                 	<div class="modal-body">
                 		...
                 		<div class="row">
                            ...
                            <div class="form-group">
                                <input type="text" id="location" name="location" value="" class="form-control" style="width: 100%;" autocomplete="off" required="required">
                           	</div>
                            </div>
                 		</div>
                 		...
                 		<div class="row">
                            ...
                            <div class="col-md-8">
                            <div class="form-group">
                                <input type="text" id="room_no" name="roomNo" value="" class="form-control" style="width: 30%;" autocomplete="off" required="required">
                           	</div>
                            </div>
                 		</div>
                 		<div class="row">
	                 		<div class="col-md-4 align-right top">
                            	<label for="potassium">POTASSIUM PERMANGANATE (gm) :</label>
                            </div>
                            <div class="col-md-8">
                            <div class="form-group">
                                <input type="text" id="potassium" name="potassium" value="" class="form-control" style="width: 30%;" autocomplete="off" required="required">
                           	</div>
                            </div>
                 		</div>
                 		<div class="row">
	                 		<div class="col-md-4 align-right top">
                            	<label for="formal">FORMALDEHYDE (37%) ml :</label>
                            </div>
                            <div class="col-md-8">
                            <div class="form-group">
                                <input type="text" id="formal" name="formal" value="" class="form-control" style="width: 30%;" autocomplete="off" required="required">
                           	</div>
                            </div>
                 		</div>
                 		<div class="row">
...
function edit(el) {
	...
	var roomNo     = $(el).closest("tr").find("#r_room_no").val();
	var potassium  = $(el).closest("tr").find("#r_potassium").val();
	var formal     = $(el).closest("tr").find("#r_formal").val();
...
$("#fumigationLogInfoForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#fumigationLogInfoForm").serialize();
    swal({
        title: "Are you sure?",
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_micro/saveFumigationInfos",
	        type: 'POST',
	        data: formData,
	        async: false,
	        success: function (data) {
	        	$("#fumigationLogInfoModal").modal('hide');
...
function printReport(el) {
	var ajaxURL = "${pageContext.request.contextPath}/logbook_micro/fumigation-record-print";
