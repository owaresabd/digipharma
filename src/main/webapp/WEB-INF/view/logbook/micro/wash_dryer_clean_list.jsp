...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">LOG BOOK:: WASH AND DRYER CLEAN INFO</span>
					...
					<table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="typeList">
						<thead>
							<tr>
								...
								<th class="align-center" style="width: 120px;">ITEM NAME</th>
								<th class="align-center" style="width: 80px;">START TIME</th>
								<th class="align-center" style="width: 80px;">END TIME</th>
								<th class="align-center" style="width: 120px;">CLEANED BY</th>
						...
						<tbody>
							...
							<tr>
								...
								<td class="align-center">
									...
									<input type="hidden" id="r_item_name" value="${info.itemName}">
...
<div class="modal fade" id="washDryerInfoModal" style="overflow: auto;" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false">
         <div class="modal-dialog  modal-lg" role="document">
             ...
             <div class="modal-header bg-cyan" >
                 	...
                 	<td rowspan="3" class="text-center font-bold" style="font-size: 16px !important">Log Book :: Wash and Dryer</td>
                 	<td style="width:90px">Document No.</td>
                 	<td colspan="2" style="width:120px">LB-DIL-MC-028</td>
                 	</tr>
                 ...
                 <form method="post" id="washDryerInfoForm" >
                 	<div class="modal-body">
                 		...
                 		<input type="hidden" id="id" name="id" value=""/>
                            ...
                            <div class="col-md-4">
					  		...
					  		<div class="col-md-2 align-right top">
                            	<label for="equipment_id">ITEM NAME OF WASHING :</label>
                            </div>
                            <div class="col-md-4">
	                            <div class="form-group">
				               <input type="text" id="item_name"  value="" class="form-control"  readonly="">
                 			   <!--	<select id="item_id" name="itemId" class="js-example-theme-single form-control" style="width: 100%;" required="required">
				                        	<option>-Select Item Name-</option>
				                        <c:forEach var="info" items="${itemInfos}">
				                           	<option value="${info.id }">${info.itemName}</option>
				                        </c:forEach>
				                    </select>-->
	                            </div>
                            </div>
                     	...
                     	<div class="row">
                            ...
                            <div class="col-md-4">
                            <div class="form-group">
                                <input type="text" id="start_time" name="startTime" value="" class="form-control" style="width: 30%;" readonly="">
                           	</div>
                            </div>
                 				<div class="col-md-2 align-right top">
                            ...
                            <div class="col-md-4">
                            <div class="form-group">
                                <input type="text" id="end_time" name="endTime" value="" class="form-control" style="width: 30%;" readonly="">
                           	</div>
                            </div>
                 		</div>
               	  	   <div class="row">
...
function editClean(el) {
	...
	var itemName    = $(el).closest("tr").find("#r_item_name").val();
...
$("#washDryerInfoForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#washDryerInfoForm").serialize();
    swal({
        title: "Are you sure?",
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_micro/cleanWashDryer",
	        type: 'POST',
	        data: formData,
	        async: false,
	        success: function (data) {
	        	$("#washDryerInfoModal").modal('hide');
