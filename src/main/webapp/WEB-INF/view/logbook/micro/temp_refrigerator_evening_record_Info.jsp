...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">TEMPERATURE REFRIGERATOR EVENING RECORD LOGBOOK INFO</span>
	</div>
				...
				<div class="body table-responsive table-bordered">
					...
					<table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="typeList" style="">
						<thead>
						  ...
						  <!--<td class="align-center" colspan="2">MORNING(08:30 AM to 09 :30 AM)</td>
								<td class="align-center" colspan="2">EVENING(03:30 PM to 04 :30 PM)</td>
								-->
                 		...
                 		<input type="hidden" id="id" name="id" value=""/>
	            			...
	            			<div class="col-md-3 align-right top">
				  			...
				  			<div class="row">
	                            ...
	                            <div class="col-md-3">
		                          <div class="form-group">
		                           <input type="text" id="evening_time" name="eveningTime" value="" class="form-control" style="width: 50%;"  autocomplete="off" required="required">
                           	   	</div>
	                           	</div>
                             </div>
				  			<div class="row">
	                            ...
	                            <div class="col-md-3">
	                            <div class="form-group">
	                                <input type="text" id="evening_temp" name="eveningTemp" value="" class="form-control" style="width: 100%;"  autocomplete="off" required="required" >
	                           	</div>
	                           	</div>
	                 		<div class="col-md-3 align-right top">
...
$("#TempRefEveningRecordForm").submit(function(event){
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_micro/saveTempRefEveningRecord",
	        type: 'POST',
	        data: formData,
	        async: false,
