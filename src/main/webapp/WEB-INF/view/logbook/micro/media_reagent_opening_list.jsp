...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">MEDIA,REAGENT AND OTHER MATERIALS RECEVING AND STOCK CONTROL OPENING INFO</span>
...
$("#mediaUpdateForm").submit(function(event){
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_micro/openMediaReagentMaterials",
	        type: 'POST',
	        data: formData,
	        async: false,
