...
<div class="container-fluid">
	<div class="block-header">
		<span style="text-shadow: 2px 2px 2px #aaa;"> LB-FUMIGATION REPORT</span>
	</div>
...
function printReport(el) {
    ...
    var ajaxURL = "${pageContext.request.contextPath}/logbook_micro/lbFumigation-log-print?fromDate=" + fromDate+ "&toDate=" + toDate;
	 $.ajax({
		type : "GET",
		url : ajaxURL,
		dataType : 'json',
