			...
			<div class="card ">
				<div class="body">
					...
					<div class="row">
						...
						<div class="col-md-3">
                           	<select id="equipment_id" class="js-example-theme-single form-control" onchange="getHotAirOvenCheckPendingInfos()" style="width: 100%;">
...
setTimeout(function() {
      getHotAirOvenCheckPendingInfos();
    }, 2);
});	 
...
function getHotAirOvenCheckPendingInfos(){
    var equipmentId = $('#equipment_id option:selected').val();
	var ajaxURL = "${pageContext.request.contextPath}/logbook_micro/getHotAirOvenCheckPendingInfos?equipmentId="+equipmentId;
		$.ajax({
			async : false,
			url : ajaxURL ,
