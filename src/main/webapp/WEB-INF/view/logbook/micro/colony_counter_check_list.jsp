...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">COLONY COUNTER CHECK INFO LIST</span>
		
	</div>
		   <form method="post" id="colonyCountCheckForm" onkeypress="if (event.keyCode == 13) { return false; }">
					...
					<table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="verifyTable">
						<thead>
							<tr>
								...
								<th class="align-left" style="width: 140px;">OPERATED BY</th>
...
$("#colonyCountCheckForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#colonyCountCheckForm").serialize();	
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_micro/checkColonyCounter",
	        type: 'POST',
	        data: formData,
	        async: false,
