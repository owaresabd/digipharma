...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">TEMPERATURE, RELATIVE HUMIDITY AND PRESSURE CONTROL MORNING RECORD LOGBOOK INFO</span>
	</div>
...
<div class="modal fade" id="tempHumPressMorningRecordModal" style="overflow: auto;" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false">
                 		...
                 		<input type="hidden" id="id" name="id" value=""/>
	                        ...
	                        <div class="col-md-2">
	                            <div class="form-group">
	                                <input type="text" id="morning_temp_bef_cor" name="morningTempBefCor" value="" class="form-control" style="width: 100%;" autocomplete="off" required="required">
	                           	</div>
	                           	</div>
	                       <div class="col-md-4 align-right top">
	                        ...
	                        <div class="col-md-2">
	                            <div class="form-group">
	                                <input type="text" id="morning_temp_aft_cor" name="morningTempAftCor" value="" class="form-control" style="width: 100%;" autocomplete="off" required="required">
	                           	</div>
	                           	</div>
	                         </div>
	             	 		<div class="row">
	                        ...
	                        <div class="col-md-2">
	                            <div class="form-group">
	                                <input type="text" id="morning_hum_bef_cor" name="morningHumBefCor" value="" class="form-control" style="width: 100%;" autocomplete="off" required="required">
	                           	</div>
	                           	</div>
	                       <div class="col-md-4 align-right top">
	                        ...
	                        <div class="col-md-2">
	                            <div class="form-group">
	                                <input type="text" id="morning_hum_aft_cor" name="morningHumAftCor" value="" class="form-control" style="width: 100%;" autocomplete="off" required="required">
	                           	</div>
	                           	</div>
	                         </div>
	            			<div class="row">
	                            ...
	                            <div class="col-md-2">
		                          <div class="form-group">
		                           <input type="text" id="morning_time" name="morningTime" value="" class="form-control" style="width: 100%;" autocomplete="off" required="required">
                           	   	</div>
	                           	</div>
	                            ...
	                            <div class="col-md-2">
	                            <div class="form-group">
	                                <input type="text" id="morning_pressure" name="morningPressure" value="" class="form-control" style="width: 100%;" autocomplete="off" required="required">
	                           	</div>
	                           	</div>
...
function add(el) { 
	$("#id").val("");
	$("#morning_time").val("");	
	$("#morning_temp_bef_cor").val("");
    $("#morning_temp_aft_cor").val("");
	$("#morning_hum_bef_cor").val("");
    $("#morning_hum_aft_cor").val("");
	$("#morning_pressure").val("");
    
	$("#remarks").val("");
    $("#tempHumPressMorningRecordModal").modal();
...
$("#TempHumidityRecordForm").submit(function(event){
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_micro/saveTempHumPressMorningRecord",
	        type: 'POST',
	        data: formData,
	        async: false,
	        success: function (data) {				 
	        	$("#tempHumPressMorningRecordModal").modal('hide');
