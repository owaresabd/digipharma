...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">TEMPERATURE, RELATIVE HUMIDITY AND PRESSURE CONTROL CHECKED INFO</span>
...
$("#tempIncubatorForm").submit(function(event){
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_micro/checkedTempHumPress",
	        type: 'POST',
	        data: formData,
	        async: false,
