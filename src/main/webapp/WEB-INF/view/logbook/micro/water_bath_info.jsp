...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">LOG BOOK:: WATER BATH INFO</span>
					...
					<table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="typeList">
						<thead>
							<tr>
								...
								<th class="align-center" style="width: 100px;">MATERIALS</th>
								<th class="align-center" style="width: 100px;">TEMPERATURE</th>
								<th class="align-center" style="width: 100px;">SWITCH ON TIME</th>
								<th class="align-center" style="width: 100px;">SWITCH OFF TIME</th>
...
<div class="modal fade" id="waterBathInfoModal" style="overflow: auto;" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false">
         <div class="modal-dialog  modal-lg" role="document">
             ...
             <div class="modal-header bg-cyan" >
                 	...
                 	<td rowspan="3" class="text-center font-bold" style="font-size: 16px !important">Log Book :: Water Bath Info</td>
                 	<td style="width:90px">Document No.</td>
                 	<td colspan="2" style="width:120px">LB-DIL-MC-022</td>
                 	</tr>
                 	...
                 	<div class="modal-body">
						...
						<div class="row">
	                 		<div class="col-md-3 align-right top">
                            	<label for="sample_name_id">MATERIALS TO BE LOADED :</label>
                            </div>
                            <div class="col-md-4">
                        ...
                        <div class="col-md-2 align-right top">
                            	<label for="location">TEMPARATURE :</label>
                            </div>
                            <div class="col-md-3">
                            <div class="form-group">
                                <input type="text" id="temperature" name="temperature" value="" class="form-control" style="width: 100%;" autocomplete="off">
                           	</div>
                            </div>
              		  </div>
                 	  <div class="row">
                            ...
                            <div class="col-md-4">
                 	   		...
                 	   		<div class="col-md-2 align-right top">
                            	<label for="start_time">SWITCH ON TIME :</label>
                            </div>
                            <div class="col-md-3">
                            <div class="form-group">
                     	...
                     	<div class="row">
	                 		<div class="col-md-3 align-right top">
                            	<label for="end_time">SWITCH OFF TIME :</label>
                            </div>
                            <div class="col-md-4">
                            <div class="form-group">
...
function edit(el) {
	...
	$("#id").val(Id);
	$("#material_id").val(materialId).trigger('change.select2');
...
$("#waterBathInfoForm").submit(function(event){
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_micro/saveWaterBathInfo",
	        type: 'POST',
	        data: formData,
	        async: false,
