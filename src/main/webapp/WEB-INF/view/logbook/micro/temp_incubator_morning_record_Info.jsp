...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">TEMPERATURE INCUBATOR MORNING RECORD LOGBOOK INFO</span>
	</div>
					...
					<table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="typeList" style="">
						<thead>
							...
							<tr>
								...
								<td class="align-center" style="width: 80px; border: 2px solid #ddd" rowspan="2">RECORDED BY</td>
					    	</tr>
							<tr>
							<td class="align-center" style="width: 80px;">TIME</td>
							<td class="align-center" style="width: 80px;">TEMP. (°C)</td>
							</tr>
						</thead>
						<tbody>
...
$("#TempHumidityRecordForm").submit(function(event){
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_micro/saveTempMorningRecord",
	        type: 'POST',
	        data: formData,
	        async: false,
