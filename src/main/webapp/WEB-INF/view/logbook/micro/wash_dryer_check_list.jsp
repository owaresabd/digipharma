...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">WASH AND DRYER CHECK INFO LIST</span>
		
	</div>
		   <form method="post" id="washDryerCheckForm" onkeypress="if (event.keyCode == 13) { return false; }">
...
$("#washDryerCheckForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#washDryerCheckForm").serialize();	
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_micro/checkWashDryer",
	        type: 'POST',
	        data: formData,
	        async: false,
