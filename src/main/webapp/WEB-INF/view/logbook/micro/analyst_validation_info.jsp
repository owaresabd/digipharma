...
<div class="modal fade" id="AnalystValidationInfoModal" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false">
         <div class="modal-dialog modal-lg" role="document">
             ...
             <div class="modal-header bg-cyan" >
                 	...
                 	<td colspan="2" style="width:110px">LB-DIL-MC-034</td>
                 	</tr>
                 ...
                 <form method="post" id="analystValidationInfoForm" onkeypress="if (event.keyCode == 13) { return false; }">
                 	...
                 	<div class="modal-body">
                 		...
                 		<div class="row">
                            ...
                            <div class="col-md-3">
                            <div class="form-group">
	                                <input type="text"  id="ud_analyst_id" name="udAnalystId" value="" class="form-control"  autocomplete="off" required="required">
                            	</div>
                            </div>
                       </div>
                 		<div class="row">
...
$("#analystValidationInfoForm").submit(function(event){
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_micro/saveAnalystValidation",
	        type: 'POST',
	        data: formData,
	        async: false,
