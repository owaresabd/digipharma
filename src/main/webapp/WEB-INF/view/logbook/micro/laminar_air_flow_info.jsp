...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">LOG BOOK:: LAMINAR AIR FLOW INFO</span>
					...
					<table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="typeList">
						<thead>
							<tr>
								...
								<th class="align-center" style="width: 100px;">PURPOSE</th>
								<th class="align-center" style="width: 100px;">LAF ON TIME</th>
								<th class="align-center" style="width: 100px;">UV ON TIME</th>
								<th class="align-center" style="width: 100px;">LAF OFF TIME</th>
								<th class="align-center" style="width: 100px;">UV OFF TIME</th>
						...
						<tbody>
							...
							<tr>
								...
								<td class="align-center">${info.lafOnTime}</td>
								<td class="align-center">${info.uvOnTime}</td>
								<td class="align-center">${info.lafOffTime}</td>
								<td class="align-center">${info.uvOffTime}</td>
								...
								<c:choose>
									...
									<input type="hidden" id="r_laf_on_time" value="${info.lafOnTime}">
									<input type="hidden" id="r_laf_off_time" value="${info.lafOffTime}">
									<input type="hidden" id="r_uv_on_time" value="${info.uvOnTime}">
									<input type="hidden" id="r_uv_off_time" value="${info.uvOffTime}">
...
<div class="modal fade" id="waterBathInfoModal" style="overflow: auto;" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false">
         <div class="modal-dialog  modal-lg" role="document">
             ...
             <div class="modal-header bg-cyan" >
                 ...
                 <form method="post" id="waterBathInfoForm" >
                 	<div class="modal-body">
                        ...
                        <div class="col-md-2 align-right top">
                            	<label for="location">PURPOSE :</label>
                            </div>
                            <div class="col-md-4">
                            <div class="form-group">
                 	  ...
                 	  <div class="row">
                     	...
                     	<div class="row">
					   		<div class="col-md-2 align-right top">
                            	<label for="laf_on_time">LAF ON TIME :</label>
                            </div>
                            <div class="col-md-4">
                            <div class="form-group">
                                <input type="text" id="laf_on_time" name="lafOnTime" value="" class="form-control" style="width: 30%;" autocomplete="off" required="required">
                           	</div>
                            </div>
                 	
	                 		<div class="col-md-2 align-right top">
                            	<label for="uv_on_time">UV ON TIME :</label>
                            </div>
                            <div class="col-md-4">
                            <div class="form-group">
                                <input type="text" id="uv_on_time" name="uvOnTime" value="" class="form-control" style="width: 30%;" autocomplete="off" required="required">
                           	</div>
                            </div>
                 		</div>
                      	<div class="row">
					   		<div class="col-md-2 align-right top">
                            	<label for="laf_off_time">LAF OFF TIME :</label>
                            </div>
                            <div class="col-md-4">
                            <div class="form-group">
                                <input type="text" id="laf_off_time" name="lafOffTime" value="" class="form-control" style="width: 30%;" autocomplete="off" required="required">
                           	</div>
                            </div>
                 	  		<div class="col-md-2 align-right top">
                            	<label for="uv_off_time">UV OFF TIME :</label>
                            </div>
                            <div class="col-md-4">
                            <div class="form-group">
                               <input type="text" id="uv_off_time" name="uvOffTime" value="" class="form-control" style="width: 30%;" autocomplete="off" required="required" />     	</div>
                            </div>
...
function edit(el) {
	...
	var lafOnTime  = $(el).closest("tr").find("#r_laf_on_time").val();
	var lafOffTime    = $(el).closest("tr").find("#r_laf_off_time").val();
	var uvOnTime  = $(el).closest("tr").find("#r_uv_on_time").val();
	var uvOffTime    = $(el).closest("tr").find("#r_uv_off_time").val();
	...
	$("#laf_on_time").val(lafOnTime);
	$("#laf_off_time").val(lafOffTime);
	$("#uv_on_time").val(uvOnTime);
	$("#uv_off_time").val(uvOffTime);
	$("#purpose").val(purpose);
	$("#remarks").val(remarks);
...
$("#waterBathInfoForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#waterBathInfoForm").serialize();
    swal({
        title: "Are you sure?",
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_micro/savelaminarAirFlowInfo",
	        type: 'POST',
	        data: formData,
	        async: false,
	        success: function (data) {
	        	$("#waterBathInfoModal").modal('hide');
