...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">LB-PREPARATION OF DISINFECTANT CHECK INFO LIST</span>
		
	</div>
		   <form method="post" id="lbPresentationCheckForm" onkeypress="if (event.keyCode == 13) { return false; }">
...
$("#lbPresentationCheckForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#lbPresentationCheckForm").serialize();	
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_micro/checklbPreparation",
	        type: 'POST',
	        data: formData,
	        async: false,
