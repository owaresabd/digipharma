...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">LOGBOOK:: WATER SAMPLING(Micro)</span>
					...
					<table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="typeList">
						<thead>
							<tr>
								...
								<th class="align-center" style="width: 100px;">SAMPLING DATE</th>
								<th class="align-center" style="width: 100px;">LOCATION</th>
								<th class="align-center" style="width: 100px;">SAMPLE ID</th>
								<th class="align-center" style="width: 100px;">WATER TYPE</th>
								<th class="align-center" style="width: 100px;">SAMPLED BY</th>
						...
						<tbody>
							...
							<tr>
								...
								<td class="align-center">${info.sampleId}</td>
								<td class="align-center">${info.waterTypeName}</td>
								...
								<td class="align-center">
									...
									<input type="hidden" id="r_water_type_id" value="${info.waterTypeId}">
...
<div class="modal fade" id="waterPurificationInfoModal" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false">
         <div class="modal-dialog modal-lg" role="document">
             ...
             <div class="modal-header bg-cyan" >
                 	...
                 	<td rowspan="3" class="text-center font-bold" style="font-size: 16px !important">Log Book::Water Sampling</td>
                 	<td style="width:90px">Document No.</td>
                 	<td colspan="2" style="width:110px">LB-DIL-MC-038</td>
                 	</tr>
                 ...
                 <form method="post" id="waterPurificationInfoForm" onkeypress="if (event.keyCode == 13) { return false; }">
                 	...
                 	<div class="modal-body">
                 		...
                 		<div class="row">
                            ...
                            <div class="col-md-4">
                            <div class="form-group">
	                                <input type="text" id="sample_id" name="sampleId" value="" class="form-control"  autocomplete="off" required="required">
                            	</div>
                            </div>
                 		...
                 		<div class="row">
	                        <div class="col-md-2 align-right top">
                            	<label for="water_type_id">WATER TYPE :</label>
                            </div>
                            <div class="col-md-4">
	                            <div class="form-group">
	                            	<select id="water_type_id" name="waterTypeId" class="js-example-theme-single form-control" style="width: 100%;" required="required">
				                        	<option>-Select Equipment-</option>
				                        <c:forEach var="info" items="${waterTypeList}">
...
function add(el) {
	...
	$("#water_type_id").val("").trigger('change.select2');
	$("#sample_id").val("");
	$("#remarks").val("");
...
function edit(el) {
	...
	var equipmentId = $(el).closest("tr").find("#r_location_id").val();
	var waterTypeId = $(el).closest("tr").find("#r_water_type_id").val();
	var sampleId 	= $(el).closest("tr").find("#r_sample_id").val();
	var remarks 	= $(el).closest("tr").find("#r_remarks").val();
		
	$("#id").val(id);
	$("#location_id").val(equipmentId).trigger('change.select2');
	$("#water_type_id").val(waterTypeId).trigger('change.select2');
...
$("#waterPurificationInfoForm").submit(function(event){
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_micro/saveWaterSampling",
	        type: 'POST',
	        data: formData,
	        async: false,
