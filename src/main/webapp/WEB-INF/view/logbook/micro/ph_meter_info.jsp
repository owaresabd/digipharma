					...
					<table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="typeList">
						<thead>
							<tr>
								...
								<th class="align-center" style="width: 80px;">TEMP (&deg;C)</th>
<<<<<<< HEAD
								<th class="align-center" style="width: 180px;">RESULT</th>
								<th class="align-center" style="width: 150px;">REMARKS</th>
=======
								<th class="align-center" style="width: 120px;">RESULT</th>
								<th class="align-left" style="width: 150px;">REMARKS</th>
>>>>>>> ac2aa9f57324e7ba841639816b520f9d5ede3bd3
...
<div class="modal fade" id="phMeterLogInfoModal" style="overflow: auto;" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false">
         <div class="modal-dialog modal-lg" role="document">
             ...
             <div class="modal-header bg-cyan" >
                 	...
                 	<td colspan="2" style="width:120px">LB-DIL-MC-011</td>
                 	</tr>
                 ...
                 <form method="post" id="phMeterLogInfoForm" modelAttribute="phMeterLogInfo">
                 	<div class="modal-body">
						...
						<div class="row">
	                 		<div class="col-md-2 align-right top">
                            	<label for="lot_no">BATCH NO. :</label>
                            </div>
                            <div class="col-md-4">
                            <div class="form-group">
...
$("#phMeterLogInfoForm").submit(function(event){
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_micro/savePhMeterInfos",
	        type: 'POST',
	        data: formData,
	        async: false,
