...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">WATER BATH CHECK INFO LIST</span>
		
	</div>
		   <form method="post" id="waterBathCheckForm" onkeypress="if (event.keyCode == 13) { return false; }">
...
$("#waterBathCheckForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#waterBathCheckForm").serialize();	
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_micro/checkWaterBath",
	        type: 'POST',
	        data: formData,
	        async: false,
