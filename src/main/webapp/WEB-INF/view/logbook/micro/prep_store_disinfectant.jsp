...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">PREPARATION AND STORAGE OF DISINFECTANT SOLUTION INFO</span>
...
<div class="modal fade" id="disinfectantSolInfoModal" style="overflow: auto;" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false">
         <div class="modal-dialog modal-lg" role="document">
             ...
             <div class="modal-header bg-cyan" >
                 	...
                 	<td rowspan="3" class="text-center font-bold" style="font-size: 16px !important">Form: Disinfectant Solution Logbook Info</td>
                 	<td style="width:90px">Document No.</td>
                 	<td colspan="2">LB-DIL-MC-001</td>
                 	</tr>
                 	...
                 	<div class="modal-body">
                 		...
                 		<div class="row">
	                 		<div class="col-md-2 align-right top">
                            	<label for="disinfec_name">Name of Disinfectant :</label>
                            </div>
                            <div class="col-md-4">
