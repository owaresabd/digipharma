...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">TEMPERATURE, RELATIVE HUMIDITY AND PRESSURE CONTROL CLEANED INFO</span>
				...
				<div class="body table-responsive table-bordered">
					<table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="verifyTable">
						...
						<tr>
								...
								<th class="align-center" style="width: 100px;" rowspan="3"><span class="input-group-addon">
...
$("#tempIncubatorForm").submit(function(event){
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_micro/cleanedTempHumPress",
	        type: 'POST',
	        data: formData,
	        async: false,
