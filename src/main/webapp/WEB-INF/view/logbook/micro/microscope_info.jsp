...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">LOG BOOK:: MICROSCOPE INFO</span>
						...
						<tbody>
							...
							<tr>
								...
								<c:choose>
									...
									<span class="badge bg-green">Checked</span>								</c:when>
									<c:otherwise>
									<a class="btn-edit btn btn-xs" onclick="edit(this)"><i class="material-icons">mode_edit</i></a>									</c:otherwise>              
								</c:choose>
								<input name="hidden" type="hidden" id="row_id" value="${info.id}" />
								<input type="hidden" id="r_record_date" value="${info.recordDate}">
									...
									<input type="hidden" id="r_equipment_id" value="${info.equipmentId}">								</td>
							</tr>
							</c:forEach>
						</tbody>
					</table>
...
<div class="modal fade" id="microscopeInfoModal" style="overflow: auto;" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false">
         <div class="modal-dialog  modal-lg" role="document">
             ...
             <div class="modal-header bg-cyan" >
                 	...
                 	<td rowspan="3" class="text-center font-bold" style="font-size: 16px !important">Log Book :: Microscope</td>
                 	<td style="width:90px">Document No.</td>
                 	<td colspan="2" style="width:120px">LB-DIL-MC-023</td>
                 	</tr>
                 ...
                 <form method="post" id="microscopeInfoForm" >
...
$("#microscopeInfoForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#microscopeInfoForm").serialize();
    swal({
        title: "Are you sure?",
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_micro/saveMicroscopeInfo",
	        type: 'POST',
	        data: formData,
	        async: false,
	        success: function (data) {
	        	$("#microscopeInfoModal").modal('hide');
