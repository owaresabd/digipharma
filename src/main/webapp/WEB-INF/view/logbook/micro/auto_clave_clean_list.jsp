					...
					<table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="typeList">
						<thead>
							<tr>
								...
								<th class="align-center" style="width: 80px;">CLEAN BY</th>
                 	...
                 	<div class="modal-body">
                 		...
                 		<input type="hidden" id="id" name="id" value=""/>
                            ...
                            <div class="col-md-4">
								...
								<input type="text" id="equipment_name" name="" value="" class="form-control" readonly="">
					  		...
					  		<div class="col-md-2 align-right top">
                               ...
                               <div class="col-md-4">
                           	<div class="form-group">
							<input type="text" id="material_name" name="" value="" class="form-control" readonly="">
                     	...
                     	<div class="row">
                            ...
                            <div class="col-md-4">
                            <div class="form-group">
                                <input type="text" id="ster_end_time" name="sterEndTime" value="" class="form-control" style="width: 30%;" readonly="">
                           	</div>
                            </div>
                 		</div>
                 	 	<div class="row">
                            ...
                            <div class="col-md-4">
                            <div class="form-group">
                                <input type="text" id="exha_start_time" name="exhaStartTime" value="" class="form-control" style="width: 30%;" readonly="">
                           	</div>
                            </div>
                 				<div class="col-md-2 align-right top">
                            ...
                            <div class="col-md-4">
                            <div class="form-group">
                                <input type="text" id="exha_end_time" name="exhaEndTime" value="" class="form-control" style="width: 30%;" readonly="">
                           	</div>
                            </div>
                 		</div>
                 	 	<div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <input type="text" id="heating_cycle" name="heatingCycle" value="" class="form-control" readonly="">
                           	</div>
                            </div>
              		    <div class="col-md-2 align-right top">
