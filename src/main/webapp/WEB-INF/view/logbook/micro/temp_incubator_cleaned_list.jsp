...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">TEMPERATURE INCUBATOR CLEANED RECORD LOGBOOK INFO</span>
	</div>
                 		...
                 		<input type="hidden" id="id" name="id" value=""/>
	                 		...
	                 		<div class="row">
	                            ...
	                            <div class="col-md-3">
									...
									<input type="text" id="equipment_name1" name="" value="" class="form-control" style="width: 50%;" disabled="disabled">
...
function editClean(el) {
	...
	var equipmentName1    = $(el).closest("tr").find("#r_equipment_name").val();
	var cleanBy    = $(el).closest("tr").find("#r_clean_by").val();
	
	$("#equipment_name1").val(equipmentName1);
...
$("#TempHumidityRecordForm").submit(function(event){
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_micro/cleanedTempIncubetor",
	        type: 'POST',
	        data: formData,
	        async: false,
