...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">TEMPERATURE REFRIGERATOR CLEANED RECORD LOGBOOK INFO</span>
	</div>
					...
					<table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="typeList" style="">
						<thead>
							<tr>
								...
								<td class="align-center" style="width: 100px;" colspan="7">OBSERVED TEMPERATURE (&deg;C)</td>
						  		<td class="align-center" style="width: 100px;" rowspan="3">CLEANED BY</td>
							...
							<tr>
								...
								<td class="align-center" style="width: 150px; border: 2px solid #ddd " rowspan="2">RECORDED BY</td>
							</tr>
							<tr>
							<td class="align-center" style="width: 100px;">TIME</td>
								<td class="align-center" style="width: 100px;">TEMP.(&deg;C)</td>
								<td class="align-center" style="width: 100px;">TIME</td>
								<td class="align-center" style="width: 100px;">TEMP. (&deg;C)</td>
							</tr>
						</thead>
						<tbody>
							...
							<tr>
								...
								<td class="align-left">
									<c:choose>
									    <c:when test="${info.eveningDoneByName == null}">
											<span class="badge bg-green">Pending</span>
									    </c:when>
										<c:otherwise>
											${info.eveningDoneByName}
										</c:otherwise>
									</c:choose>
								</td>
								...
								<a class="btn-edit btn btn-xs" onclick="editClean(this)"><i class="material-icons">mode_edit</i></a>
									...
									<input type="hidden" id="r_evening_temp" value="${info.eveningTemp}">
									<input type="hidden" id="r_evening_time" value="${info.eveningTime}">
...
<div class="modal fade" id="TempRefMorningRecordModal" style="overflow: auto;" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false">
         <div class="modal-dialog modal-lg" role="document">
             ...
             <div class="modal-header bg-cyan" >
                 	...
                 	<td rowspan="3" class="text-center font-bold" style="font-size: 16px !important">Form: Temperature and Cleaning Record of Refrigerator</td>
                 ...
                 <form method="post" id="TempRefEveningRecordForm" modelAttribute="refrigeratorInfo">
                 	<div class="modal-body">
                 		...
                 		<input type="hidden" id="id" name="id" value=""/>
	                 		...
	                 		<div class="row">
	                            ...
	                            <div class="col-md-3">
		                            <div class="form-group">
									    <input type="text" id="equipment_name" name="" value="" class="form-control" style="width: 100%;" disabled="disabled" >
	                      
		                            	<!--<select id="equipment_id" name="equipmentId" class="js-example-theme-single form-control" style="width: 100%;" disabled="disabled">
	            			...
	            			<div class="col-md-3 align-right top">
	                            ...
	                            <div class="col-md-3">
		                          <div class="form-group">
		                           <input type="text" id="morning_time" name="morningTime" value="" class="form-control" style="width: 50%;" disabled="disabled">
                           	   	</div>
	                           	</div>
                             </div>
				  			<div class="row">
	            				...
	            				<div class="col-md-3 align-right top">
	                            	<label for="qty">MORNING TEMPERATURE (&deg;C) :</label>
	                            </div>
	                            <div class="col-md-3">
	                            <div class="form-group">
	                                <input type="text" id="morning_temp" name="morningTemp" value="" class="form-control" style="width: 100%;" disabled="disabled">
	                           	</div>
	                           	</div>
	                            
	            				<div class="col-md-3 align-right top">
	                            	<label for="qty">EVENING TIME :</label>
	                            </div>
	                            <div class="col-md-3">
		                          <div class="form-group">
		                           <input type="text" id="evening_time" name="eveningTime" value="" class="form-control" style="width: 50%;"  disabled="disabled">
                           	   	</div>
	                           	</div>
                             </div>
				  			<div class="row">
	            				...
	            				<div class="col-md-3 align-right top">
	                            	<label for="qty">EVENING TEMPERATURE (&deg;C) :</label>
	                            </div>
	                            <div class="col-md-3">
	                            <div class="form-group">
	                                <input type="text" id="evening_temp" name="eveningTemp" value="" class="form-control" style="width: 100%;" disabled="disabled" >
	                           	</div>
	                           	</div>
	                 		<div class="col-md-3 align-right top">
                            	<label for="agent_id">CLEANING AGENT:</label>
                            </div>
                     	    <div class="col-md-3">
                           	<div class="form-group">
					          <input type="text" id="agent_name" name="" value="" class="form-control" style="width: 100%;" disabled="disabled" >
	                      	<!--   <select  id="agent_id" name="agentId" class="js-example-theme-single form-control" style="width: 100%;" required="required">
			                        <option value="">-Select Agent-</option>
			                        <c:forEach var="info" items="${cleaningAgentInfos}">
			                           	<option value="${info.id }">${info.agentName}</option>
			                        </c:forEach>
			                    </select>-->
                           </div>
                            </div>
             			...
             			<div class="row">
	                 	 <div class="col-md-3 align-right m-t-20">
	                           ...
	                           <div class="col-md-9 m-t-15">
	                           	<div class="form-group">
	                               	<textarea rows="2" id="remarks" name="remarks" class="form-control" maxlength="220" disabled="disabled" placeholder="Description goes here......." ></textarea>
		                           </div>
	                         </div>
	           		</div>
...
function editClean(el) {
	...
	var eveningTime = $(el).closest("tr").find("#r_evening_time").val();
	var eveningTemp		 = $(el).closest("tr").find("#r_evening_temp").val();
	...
	$("#evening_time").val(eveningTime);
	$("#evening_temp").val(eveningTemp);
	//$("#agent_id").val(agentId).trigger('change.select2');
	$("#remarks").val(remarks);
	
	$("#TempRefMorningRecordModal").modal();
...
$("#TempRefEveningRecordForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#TempRefEveningRecordForm").serialize();
    swal({
        title: "Are you sure?",
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_micro/cleanedTempRefrigerator",
	        type: 'POST',
	        data: formData,
	        async: false,
	        success: function (data) {				 
	        	$("#TempRefMorningRecordModal").modal('hide');
