			...
			<div class="card ">
				<div class="body">
					...
					<div class="row">
						...
						<div class="col-md-3">
                           	<select id="equipment_id" class="js-example-theme-single form-control" onchange="getCheckedTempIncubetorPendingInfos()" style="width: 100%;">
...
setTimeout(function() {
      getCheckedTempIncubetorPendingInfos();
    }, 2);
});	 
...
function getCheckedTempIncubetorPendingInfos(){
    var equipmentId = $('#equipment_id option:selected').val();
	var ajaxURL = "${pageContext.request.contextPath}/logbook_micro/getCheckedTempIncubetorPendingInfos?equipmentId="+equipmentId;
		$.ajax({
			async : false,
			url : ajaxURL ,
