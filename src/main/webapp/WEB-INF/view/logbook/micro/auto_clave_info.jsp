...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">LOG BOOK:: AUTO CLAVE INFO</span>
						...
						<tbody>
							...
							<tr>
								...
								<c:otherwise>
									...
									<input type="hidden" id="r_exha_start_time" value="${info.exhaStartTime}">
									<input type="hidden" id="r_exha_end_time" value="${info.exhaStartTime}">
...
<div class="modal fade" id="autoClaveInfoModal" style="overflow: auto;" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false">
         <div class="modal-dialog  modal-lg" role="document">
             ...
             <div class="modal-header bg-cyan" >
                 	...
                 	<td rowspan="3" class="text-center font-bold" style="font-size: 16px !important">Log Book :: Auto Clave</td>
                 	<td style="width:90px">Document No.</td>
                 	<td colspan="2" style="width:120px">LB-DIL-MC-025</td>
                 	</tr>
                 ...
                 <form method="post" id="autoCleveInfoForm" >
                 	<div class="modal-body">
                     	...
                     	<div class="row">
                            ...
                            <div class="col-md-4">
                            <div class="form-group">
                                <input type="text" id="ster_start_time" name="sterStartTime" value="" class="form-control" style="width: 30%;" autocomplete="off" required="required">
                           	</div>
                            </div>
                 				<div class="col-md-2 align-right top">
                            ...
                            <div class="col-md-4">
                            <div class="form-group">
                                <input type="text" id="ster_end_time" name="sterEndTime" value="" class="form-control" style="width: 30%;" autocomplete="off" required="required">
                           	</div>
                            </div>
                 		</div>
                 	 	<div class="row">
	                    		<div class="col-md-2 align-right top">
                            	<label for="start_time">EXHAUST START TIME :</label>
                            </div>
                            <div class="col-md-4">
                            <div class="form-group">
                                <input type="text" id="exha_start_time" name="exhaStartTime" value="" class="form-control" style="width: 30%;" autocomplete="off" required="required">
                           	</div>
                            </div>
                 				<div class="col-md-2 align-right top">
                            	<label for="end_time">EXHAUST END TIME :</label>
                            </div>
                            <div class="col-md-4">
                            <div class="form-group">
                                <input type="text" id="exha_end_time" name="exhaEndTime" value="" class="form-control" style="width: 30%;" autocomplete="off" required="required">
                           	</div>
                            </div>
                 		</div>
                 	 	<div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <input type="text" id="heating_cycle" name="heatingCycle" value="" class="form-control" style="width: 100%;" autocomplete="off">
                           	</div>
                            </div>
              		    <div class="col-md-2 align-right top">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <input type="text" id="total_cycle" name="totalCycle" value="" class="form-control" style="width: 100%;" autocomplete="off">
                           	</div>
                            </div>
              		  </div>
                 	 	<div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <input type="text" id="batch_no" name="batchNo" value="" class="form-control" style="width: 100%;" autocomplete="off">
                           	</div>
                            </div>
              		    <div class="col-md-2 align-right top">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <input type="text" id="indicator_tape" name="indicatorTape" value="" class="form-control" style="width: 100%;" autocomplete="off">
                           	</div>
                            </div>
              		  </div>
...
function edit(el) {
	...
	var exhaStartTime = $(el).closest("tr").find("#r_exha_start_time").val();
	var exhaEndTime = $(el).closest("tr").find("#r_exha_end_time").val();
	...
	$("#exha_start_time").val(exhaStartTime);
	$("#exha_end_time").val(exhaEndTime);	
...
$("#autoCleveInfoForm").submit(function(event){
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_micro/saveAutoClaveInfo",
	        type: 'POST',
	        data: formData,
	        async: false,
