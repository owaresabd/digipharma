					...
					<table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="verifyTable">
						<thead>
							<tr>
								...
								<th class="align-center" style="width: 80px;">TIME</th>
								...
								<th class="align-left" style="width: 120px;">REMARKS</th>
						...
						<tbody>
							...
							<tr>
								...
								<td class="align-center">${info.checkType}</td>
...
$("#analyticalVerifyForm").submit(function(event){
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_micro/verifyAnalyticalBalance",
	        type: 'POST',
	        data: formData,
	        async: false,
