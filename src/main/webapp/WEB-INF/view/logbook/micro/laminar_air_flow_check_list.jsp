...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">LAMINAR AIR FLOW CHECK INFO LIST</span>
		
	</div>
		   <form method="post" id="laminarAirFlowCheckForm" onkeypress="if (event.keyCode == 13) { return false; }">
...
$("#laminarAirFlowCheckForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#laminarAirFlowCheckForm").serialize();	
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_micro/checklaminarAirFlow",
	        type: 'POST',
	        data: formData,
	        async: false,
