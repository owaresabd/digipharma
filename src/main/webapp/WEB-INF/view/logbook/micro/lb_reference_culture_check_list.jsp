...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">LB-REFERENCE CULTURE RECIVING INFO LIST</span>
		
	</div>
		   <form method="post" id="lbReferenceCheckForm" onkeypress="if (event.keyCode == 13) { return false; }">
...
$("#lbReferenceCheckForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#lbReferenceCheckForm").serialize();	
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/logbook_micro/checklbReferenceCulture",
	        type: 'POST',
	        data: formData,
	        async: false,
