														...
														<div class="panel-heading">
															<h4 class="panel-title">
																<a role="button" data-toggle="collapse"
																	aria-expanded="true"> SUPPLIER &amp; PRODUCT
																	INFORMATION </a>
															</h4>
														</div>
														<div id="collapseOne_9" class="panel-collapse collapse in"
                 			...
                 			<div class="col-md-2">
                 				<span><b>PO NO</b></span>
                               	<div class="form-group">
	                                 <div class="form-line">
	                                     <input type="text" id="po_no" name="poNo" value="${poNo}" class="form-control" readonly="readonly">
	                                 </div>
	                             </div>
                 			</div>
                 			<div class="col-md-2">
                            	<span><b>PO DATE</b></span>
                               	<div class="form-group">
