...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">PUCHASE LIST</span>
					...
					<table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="typeList">
						<thead>
							<tr>
								...
								<th class="align-left">PUCHASE NO</th>
								<th class="align-left">PUCHASE DATE</th>
								<th class="align-center" style="width: 100px;">SUPPLIER NAME</th>
