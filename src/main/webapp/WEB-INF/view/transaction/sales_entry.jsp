					...
					<div class="row clearfix">
						<div class="col-xs-12 ol-sm-12 col-md-12 col-lg-12">
							<div class="panel-group" id="accordion_9" role="tablist"
														...
														<div class="panel-heading">
															<h4 class="panel-title">
																<a role="button" data-toggle="collapse"
																	aria-expanded="true"> CUSTOMER &amp; PRODUCT
																	INFORMATION </a>
															</h4>
														</div>
														<div id="collapseOne_9" class="panel-collapse collapse in"
                 			...
                 			<div class="col-md-2">
                 				<span><b>SALES NO</b></span>
                               	<div class="form-group">
	                                 <div class="form-line">
	                                     <input type="text" id="po_no" name="poNo" value="${salesNo}" class="form-control" readonly="readonly">
	                                 </div>
	                             </div>
                 			</div>
                 			<div class="col-md-2">
                            	<span><b>SALES DATE</b></span>
                               	<div class="form-group">
                 		...
                 		<div class="row">
                 			...
                 			<div class="col-md-2">
                 				<span><b>PRODUCT NAME</b></span>
                               	<div class="form-group">
	                                 <div class="form-line">
	                                     <input type="text" id="po_no" name="poNo" value="" class="form-control"  maxlength="6" autocomplete="off" required>
	                                 </div>
	                             </div>
                 			</div>
                 			<div class="col-md-2">
							...
							<i class="material-icons aa">add</i><i class="material-icons aa">fiber_new</i>
						</button>
								</div>
                            </div>
						...
						<table class="table table-bordered table-striped table-hover" id="repairInfo">
							<thead>
								<tr>
									...
									<th class="align-center">UNIT NAME</th>
