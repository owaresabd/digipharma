    ...
    <table class="table table-bordered" style="border: 2px solid #ddd;">
		...
		<tr style="border: 2px solid #ddd;">                 	
       	...
       	<td colspan="2">15 Jan 2020</td>
                ...
                <form method="post" id="productionCssInfoForm"  onkeypress="if (event.keyCode == 13) { return false; }">
...
<script>
$("#productionCssInfoForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#productionCssInfoForm").serialize();
	swal({
        title: "Are you sure?",
    	...
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/production/save-css-info",
	        type: 'POST',
	        data: formData,
	        async: false,
	        success: function (data) {				 
	        	$("#productionViewInfoModal").modal('hide');
