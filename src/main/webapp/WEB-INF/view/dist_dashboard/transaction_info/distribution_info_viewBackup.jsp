...
<div class="modal-header bg-cyan">
    <table class="table table-bordered" style="border: 2px solid #ddd;">
    	...
    	<tr>
    	<td rowspan="3" style="width:50px"><img class="p-l-5" alt="Logo" src="/lims/image/drug-red-logo.png"></td>
    	<td rowspan="3" style="width:110px">DRUG INTERNATIONAL<br> LIMITED (UNIT-2)</td>
    	<td rowspan="3" class="text-center font-bold" style="font-size: 16px !important">Form : Work Order Details</td>
    	<td style="width:130px">Document No.</td>
    	<td colspan="2">FM-DIL-GN-083</td>
    	</tr>
                 		...
                 		<table id="reqTable" class="table table-bordered table-striped table-hover">
											<thead>
												...
												<td class="align-center">1</td>
													...
													<td class="align-center">${info.testUnitName}</td>
