					...
					<table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="typeList">
						...
						<tbody>
							...
							<tr>
								...
								<fmt:formatDate var="receiveDate" value="${info.chemiDistDate}" pattern="dd-MMM-yyyy hh:mm:ss aa"/>
								${receiveDate}
								</td>
								...
								<td class="align-center">
									...
									<a class="btn-edit btn btn-xs" onclick="dsChemiInfoPrint('${info.id}','${info.udSampleNo}')"><i class="material-icons">print</i></a>
								</td>
							</tr>
							</c:forEach>
						</tbody>
...
function view(el) {
	...
	$.ajax({
		async : false,
		url : "${pageContext.request.contextPath}/distribution/getDistributedInfo/" + id ,
...
function dsChemiInfoPrint(id,sampleNo) {
	var ajaxURL = "${pageContext.request.contextPath}/distribution/dsChemi-report?requestId="+id+'&sampleNo='+sampleNo;
