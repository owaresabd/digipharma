...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">QM INFORMATION</span>
		...
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<div class="card">
				<div class="body table-responsive table-bordered">
					...
					<table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="insTable">
						<thead>
							<tr>
								...
								<th class="align-left">QM NAME</th>
								<th class="align-left">QM ID</th>
						...
						<tbody>
							...
							<tr>
								...
								<td class="field_type_remarks">${info.qmName}</td>
								<td class="field_qm_name">${info.udQmId}</td>
								...
								<td class="align-center">
									...
									<input type="hidden" id="r_qm_name" value="${info.qmName}">
									<input type="hidden" id="r_ud_qm" value="${info.udQmId}">
									<input type="hidden" id="r_revision_no" value="${info.revisionNo}">
									<input type="hidden" id="r_effective_date" value="${info.effectiveDate}">
									<input type="hidden" id="r_doc_name" value="${info.attachmentFile}"> <!-- This for file get  inside of project -->
									<%-- <input type="hidden" id="r_doc_name" value="${pageContext.request.contextPath}/image/qm_doc/${info.attachmentFile}"> --%><!-- This for file get from outside of project -->
					...
					<%-- 				<a id="down_link" class="btn-edit btn btn-xs"  href="${filePath}${info.attachmentFile}" target="_blank"><i class="fa fa-eye"></i></a> --%>
									<a id="down_link" class="btn-edit btn btn-xs"  href="${pageContext.request.contextPath}/image/qm_doc/${info.attachmentFile}" target="_blank"><i class="fa fa-eye"></i></a>
									</c:if>
								</td>
							</tr>
							</c:forEach>
...
<div class="modal fade" id="qmInfoModal"  role="dialog" data-backdrop="static" data-keyboard="false">
         <div class="modal-dialog" role="document">
             ...
             <div class="modal-header bg-cyan" >
                 	...
                 	<td rowspan="3" class="text-center font-bold" style="font-size: 16px !important">Form: QM Info </td>
                 	<td>Document No.</td>
                 ...
                 <form method="post" id="qmInfoForm" modelAttribute="qmInfo" enctype="multipart/form-data">
                 		...
                 		<div class="row">
                            ...
                            <div class="col-md-8">
	                            <div class="form-group">
	                            	<input type="text" id="qmName" name="qmName" class="form-control"   autocomplete="off" >
	                            </div>
                            </div>
                 		</div>
                 		<div class="row">
	                 		<div class="col-md-4 align-right top">
                            	<label for="qm_name">QM ID. :</label>
                            </div>
                            <div class="col-md-8">
	                            <div class="form-group">
	                            	<input type="text" id="udQmId" name="udQmId" class="form-control"   autocomplete="off" >
	                            </div>
                            </div>
                 		</div>
                 		<div class="row">
...
function edit(el) { 
	...
	var qmName 	= $(el).closest("tr").find("#r_qm_name").val();
	var udQmId 	= $(el).closest("tr").find("#r_ud_qm").val();
	...
	$("#remarks").val(remarks);
	$("#img_name").attr('src', "${pageContext.request.contextPath}/image/qm_doc/"+attachmentFile);
...
$("#qmInfoForm").submit(function(event){
	event.preventDefault();				
	  var formData = new FormData($("#qmInfoForm")[0]);
    swal({
        title: "Are you sure?",
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/qm_info/save-qm-info",
	        type: 'POST',
	        data: formData,
