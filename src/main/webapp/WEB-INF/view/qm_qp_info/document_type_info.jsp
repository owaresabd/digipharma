...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">DOCYMENT TYPE INFORMATION</span>
					...
					<table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="typeList">
						<thead>
							<tr>
								...
								<th class="align-left">DOCUMENT TYPE NAME</th>
...
<div class="modal fade" id="docTypeInfoModal" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false">
         <div class="modal-dialog" role="document">
             <div class="modal-content">
                 <div class="modal-header bg-blue-grey">
                 	<button type="button" class="mod-cl close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    <h4 class="modal-title align-center" id="defaultModalLabel">DOCUMENT TYPE INFORMATION</h4>
                 </div>
                 <form method="post" id="docTypeInfoForm" modelAttribute="docTypeInfo">
...
$('#type_name').keyup(function() {
	...
	$.get( "${pageContext.request.contextPath}/docType/validate-docTypeName/" + typeName, 
	function( data ) {
...
function edit(el) { 
	...
	var typeName 	= $(el).closest("tr").find("#r_type_name").val();
...
$("#docTypeInfoForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#docTypeInfoForm").serialize();
    swal({
        title: "Are you sure?",
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/docType/save-docType-info",
	        type: 'POST',
	        data: formData,
	        async: false,
	        success: function (data) {				 
	        	$("#docTypeInfoModal").modal('hide');
