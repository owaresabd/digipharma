...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">DOCUMENT INFORMATION</span>
					...
					<table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="insTable">
						...
						<tbody>
							...
							<tr>
								...
								<td class="field_type_remarks">${info.udQpId}</td>
								<td class="field_type_remarks">${info.udDocumentId}</td>
								<td class="field_qm_name">${info.documentName}</td>
								<td class="field_qm_name">${info.docTypeName}</td>
								<td class="field_qm_name">${info.effectiveDate}</td>
								...
								<td class="align-center">
									...
									<input type="hidden" id="row_qp_id" value="${info.qpId}">
									<input type="hidden" id="row_type_id" value="${info.docTypeId}">
									<input type="hidden" id="r_doc_name" value="${info.documentName}">
									<input type="hidden" id="r_ud_doc_id" value="${info.udDocumentId}">
...
<div class="modal fade" id="docInfoModal"  role="dialog" data-backdrop="static" data-keyboard="false">
         <div class="modal-dialog" role="document">
             ...
             <div class="modal-header bg-cyan" >
                 	...
                 	<td rowspan="3" class="text-center font-bold" style="font-size: 16px !important">Form:Document Information </td>
                 	<td>Document No.</td>
                 ...
                 <form method="post" id="docInfoForm" modelAttribute="docInfo" enctype="multipart/form-data">
                 	<div class="modal-body">
                 		...
                 		<div class="row">
                            ...
                            <div class="col-md-8">
	                            <div class="form-group">
	                            	<select id="qpId" name="qpId" class="js-example-theme-single form-control" required="required" style="width: 100%;">
				                        	<option value="">--Select One--</option>
				                        <c:forEach var="info" items="${qpInfos}">
				                           	<option value="${info.id }">${info.qpName}</option>
				                        </c:forEach>
				                        </select>
	                            </div>
                            </div>
                 		...
                 		<div class="row">
	                 		<div class="col-md-4 align-right top">
                            	<label for="qm_name">DOCUMENT TYPE:</label>
                            </div>
                            <div class="col-md-8">
	                            <div class="form-group">
	                            	<select id="docTypeId" name="docTypeId" class="js-example-theme-single form-control" required="required" style="width: 100%;">
				                        	<option value="">--Select One--</option>
				                        <c:forEach var="info" items="${docTypeInfos}">
                 		...
                 		<div class="row">
	                 		<div class="col-md-4 align-right top">
                            	<label for="qm_name">DOCUMENT NAME:</label>
                            </div>
                            <div class="col-md-8">
	                            <div class="form-group">
	                            	<input type="text" id="documentName" name="documentName" class="form-control"   autocomplete="off" >
	                            </div>
                            </div>
                 		</div>
                 		<div class="row">
	                 		<div class="col-md-4 align-right top">
                            	<label for="qm_name">DOCUMENT ID. :</label>
                            </div>
                            <div class="col-md-8">
	                            <div class="form-group">
	                            	<input type="text" id="udDocumentId" name="udDocumentId" class="form-control"   autocomplete="off" >
	                            </div>
                            </div>
                 		</div>
                 		<div class="row">
