...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">GENERIC LIST</span>
					...
					<table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="typeList">
						...
						<tbody>
							...
							<tr>
								...
								<td class="field_type_name">${info.genericName}</td>
								...
								<td class="align-center">
									...
									<input type="hidden" id="s_name" value="${info.genericName}">
...
<div class="modal fade" id="genericInfoModal" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false">
         <div class="modal-dialog" role="document">
             <div class="modal-content">
                 <div class="modal-header bg-blue-grey">
                 	<button type="button" class="mod-cl close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    <h4 class="modal-title align-center" id="defaultModalLabel">GENERIC INFORMATION</h4>
                 </div>
                 <form method="post" id="genericInfoForm" modelAttribute="genericInfo">
                 	<div class="modal-body">
                 		...
                 		<div class="row">
	                 		<div class="col-md-4 align-right top">
                            	<label for="service_type">GENERIC NAME :</label>
                            </div>
                            <div class="col-md-8">
                            <div class="form-group">
                            	<input type="text" id="genericName" name="genericName" value="" class="form-control" placeholder="generic Name" autocomplete="off" required="required">
                            </div>
                            </div>
                 		</div>
...
$("#genericInfoForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#genericInfoForm").serialize();
    
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/generic/save-generic-info",
	        type: 'POST',
	        data: formData,
	        async: false,
