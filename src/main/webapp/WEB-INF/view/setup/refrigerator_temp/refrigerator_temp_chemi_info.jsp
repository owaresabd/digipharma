         ...
         <div class="modal-dialog" role="document">
             <div class="modal-content">
                  <div class="modal-header bg-blue-grey">
                    ...
                    <h4 class="modal-title align-center" id="defaultModalLabel">TEMPERATURE REFRIGERATOR SETUP INFO</h4>
                 </div>
...
$("#tempRefrigeratotInfoForm").submit(function(event){
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/refrigeratorSetup/saveRefrigeratorTempChemiSetupInfos",
	        type: 'POST',
	        data: formData,
	        async: false,
