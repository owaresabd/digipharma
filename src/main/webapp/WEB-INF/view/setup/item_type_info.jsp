...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">MEDICINE TYPE LIST</span>
					...
					<table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="typeList">
						<thead>
							<tr>
								...
								<th class="align-leftr">MEDICINE TYPE NAME</th>
...
<div class="modal fade" id="itemTypeInfoModal" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false">
         <div class="modal-dialog" role="document">
             <div class="modal-content">
                 <div class="modal-header bg-blue-grey">
                 	<button type="button" class="mod-cl close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    <h4 class="modal-title align-center" id="defaultModalLabel">MEDICINE TYPE INFORMATION</h4>
                 </div>
                 <form method="post" id="itemTypeInfoForm" modelAttribute="itemTypeInfo">
                 	<div class="modal-body">
                 		...
                 		<div class="row">
	                 		<div class="col-md-4 align-right top">
                            	<label for="service_type">MEDICINE TYPE NAME :</label>
                            </div>
                            <div class="col-md-8">
                            <div class="form-group">
                            	<input type="text" id="typeName" name="typeName" required="required" value="" class="form-control" placeholder="Item Type Name" autocomplete="off">
                            </div>
                            </div>
                 		</div>
...
$("#itemTypeInfoForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#itemTypeInfoForm").serialize();
    
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/item_type/save-item-type",
	        type: 'POST',
	        data: formData,
	        async: false,
	        success: function (data) {				 
	        	$("#itemTypeInfoModal").modal('hide');
