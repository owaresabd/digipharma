...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">DESIGNATION ENTRY</span>
			...
			<div class="card">
				<div class="body table-responsive table-bordered">
					...
					<table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="typeList">
						...
						<tbody>
							<c:forEach var="info" items="${designationList}" varStatus="counter">
							<tr>
								<td class="align-center">${counter.count}</td>
								<td class="field_type_name">${info.designationName}</td>
								...
								<td class="align-center">
									...
									<input type="hidden" id="s_name" value="${info.designationName}">
                 	...
                 	<div class="modal-body">
                 		...
                 		<div class="row">
                            ...
                            <div class="form-group">
                            	<input type="text" id="designationName" name="designationName" value="" class="form-control" placeholder="Department Name" autocomplete="off" required="required">
                            </div>
                            </div>
                 		</div>
