...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">EXPENSE TYPE LIST</span>
					...
					<table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="typeList">
						<thead>
							<tr>
								...
								<th class="align-leftr">EXPENSE TYPE NAME</th>
         ...
         <div class="modal-dialog" role="document">
             <div class="modal-content">
                 <div class="modal-header bg-blue-grey">
                    ...
                    <h4 class="modal-title align-center" id="defaultModalLabel">EXPENSE TYPE INFORMATION</h4>
                 </div>
                 <form method="post" id="itemTypeInfoForm" modelAttribute="expenseTypeInfo">
                 	<div class="modal-body">
                 		...
                 		<div class="row">
	                 		<div class="col-md-4 align-right top">
                            	<label for="service_type">EXPENSE TYPE NAME :</label>
                            </div>
                            <div class="col-md-8">
...
$("#itemTypeInfoForm").submit(function(event){
    ...
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/expense_type/save-expense-type",
	        type: 'POST',
	        data: formData,
	        async: false,
