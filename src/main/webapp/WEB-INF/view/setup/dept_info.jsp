...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">DEPARTMENT LIST</span>
         ...
         <div class="modal-dialog" role="document">
             <div class="modal-content">
                 <div class="modal-header bg-blue-grey">
                    ...
                    <h4 class="modal-title align-center" id="defaultModalLabel">DEPARTMENT INFORMATION</h4>
                 </div>
                 	...
                 	<div class="modal-body">
                 		...
                 		<div class="row">
                            ...
                            <div class="form-group">
                            	<input type="text" id="departmentName" name="departmentName" value="" class="form-control" placeholder="Department Name" autocomplete="off" required="required">
                            </div>
                            </div>
                 		</div>
