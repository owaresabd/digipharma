...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">SUPPLIER TYPE LIST</span>
					...
					<table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="typeList">
						<thead>
							<tr>
								...
								<th class="align-leftr">SUPPLIER TYPE NAME</th>
         ...
         <div class="modal-dialog" role="document">
             <div class="modal-content">
                 <div class="modal-header bg-blue-grey">
                    ...
                    <h4 class="modal-title align-center" id="defaultModalLabel">SUPPLIER TYPE INFO</h4>
                 </div>
                 <form method="post" id="supplierTypeInfoForm" modelAttribute="supplierTypeInfo">
                 	<div class="modal-body">
                 		...
                 		<div class="row">
	                 		<div class="col-md-4 align-right top">
                            	<label for="service_type">SUPPLIER TYPE NAME :</label>
                            </div>
                            <div class="col-md-8">
                            <div class="form-group">
                            	<input type="text" id="typeName" name="typeName" required="required" value="" class="form-control"  autocomplete="off">
                            </div>
                            </div>
                 		</div>
...
$("#supplierTypeInfoForm").submit(function(event){
	event.preventDefault();				
    var formData = $("#supplierTypeInfoForm").serialize();
    
    if($(".alert-code").hasClass('hidden')){
    	$.ajax({	
	    	url : "${pageContext.request.contextPath}/supplier_type/save-supplier-type",
	        type: 'POST',
	        data: formData,
	        async: false,
