...
<div class="container-fluid">
	<div class="block-header">
	   <span style="text-shadow: 2px 2px 2px #aaa;">WORKING STANDARD REPORT LIST</span>
					...
					<table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="typeList">
						<thead>
							<tr>
								...
								<th class="align-left" style="width: 200px;">NAME OF THE MATERIAL</th>
...
function testReportPrint(id,udId,rptDate) {
	...
	var ajaxURL = "${pageContext.request.contextPath}/working_standard/test-report-info-print?sampleId="+id+'&udSampleId='+udId+'&reportDate='+datVal;
...
function view(el) {
	...
	$.ajax({
		async : false,
		url : "${pageContext.request.contextPath}/working_standard/getTestResultDetailsInfo/"+ id ,
		success : function(data) {
