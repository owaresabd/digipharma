...
@Entity
@Table(name = "log_mc_temp_hum_press_record_infos")
public class LogMCTempHumPressRecordInfo {
	...
	@Transient
	private String morningTempBefCor;
	
	@Transient
	private String morningTempAftCor;	
	
	@Transient
	private String morningHumBefCor;
	
	@Transient
	private String morningHumAftCor;	
	
	@Transient
	private String morningPressure;		
	
	@Transient
	private String eveningTempBefCor;
	
	@Transient
	private String eveningTempAftCor;
	
	@Transient
	private String eveningHumBefCor;
	
	@Transient
	private String eveningHumAftCor;
	...
	public String getMorningTempBefCor() {
		return morningTempBefCor;
	}

	public void setMorningTempBefCor(String morningTempBefCor) {
		this.morningTempBefCor = morningTempBefCor;
	}

	public String getMorningTempAftCor() {
		return morningTempAftCor;
	}

	public void setMorningTempAftCor(String morningTempAftCor) {
		this.morningTempAftCor = morningTempAftCor;
	}

	public String getMorningHumBefCor() {
		return morningHumBefCor;
	}

	public void setMorningHumBefCor(String morningHumBefCor) {
		this.morningHumBefCor = morningHumBefCor;
	}

	public String getMorningHumAftCor() {
		return morningHumAftCor;
	}

	public void setMorningHumAftCor(String morningHumAftCor) {
		this.morningHumAftCor = morningHumAftCor;
	}
	...
	public String getEveningTempBefCor() {
		return eveningTempBefCor;
	}

	public void setEveningTempBefCor(String eveningTempBefCor) {
		this.eveningTempBefCor = eveningTempBefCor;
	}

	public String getEveningTempAftCor() {
		return eveningTempAftCor;
	}

	public void setEveningTempAftCor(String eveningTempAftCor) {
		this.eveningTempAftCor = eveningTempAftCor;
	}

	public String getEveningHumBefCor() {
		return eveningHumBefCor;
	}

	public void setEveningHumBefCor(String eveningHumBefCor) {
		this.eveningHumBefCor = eveningHumBefCor;
	}

	public String getEveningHumAftCor() {
		return eveningHumAftCor;
	}

	public void setEveningHumAftCor(String eveningHumAftCor) {
		this.eveningHumAftCor = eveningHumAftCor;
	}
