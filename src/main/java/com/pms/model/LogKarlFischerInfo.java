...
@Entity
@Table(name = "lims_log_karl_fischer_infos")
public class LogKarlFischerInfo {
	...
	@Column(name = "kft_result")
	private String kftResult;
	...
	public String getKftResult() {
		return kftResult;
	}

	public void setKftResult(String kftResult) {
		this.kftResult = kftResult;
	}
