...
import com.pms.repository.DistributionMicroRepository;
import com.pms.repository.ResultRepository;

@Service
public class DistributionMicroService {

	@Autowired
	private DistributionMicroRepository distributionRepository;
	@Autowired
	...
	public void saveDistributionInfo(Map<String, String[]> requestMap) {
		...
		if (requestMap.containsKey("distParameterNo")) {
			...
			distributionRepository.updateMicroDistributionInfo(UUID.fromString(mstId));
		}
	}
